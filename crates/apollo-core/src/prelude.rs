//! Everything you need to get started with Apollo.
...
pub use apollo_compute::rolling::{
    QuantileMethod, RollingFnParams, RollingRankMethod, RollingVarParams,
};
pub use apollo_row::RowEncodingOptions;
pub use apollo_utils::aliases::*;
pub use apollo_utils::index::{ChunkId, IdxSize, NullableIdxSize};
pub use apollo_utils::pl_str::PlSmallStr;
pub(crate) use apollo_utils::total_ord::{TotalEq, TotalOrd};
...
pub use crate::chunked_array::iterator::ApolloIterator;
#[cfg(feature = "dtype-categorical")]
pub use crate::chunked_array::logical::categorical::*;
#[cfg(feature = "ndarray")]
pub use crate::chunked_array::ndarray::IndexOrder;
#[cfg(feature = "object")]
pub use crate::chunked_array::object::ApolloObject;
...
pub use crate::error::{
    ApolloError, ApolloResult, apollo_bail, apollo_ensure, apollo_err, apollo_warn,
};

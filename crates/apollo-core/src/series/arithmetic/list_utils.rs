...
use apollo_compute::comparisons::TotalEqKernel;
...
impl NumericOp {
    ...
    pub(super) fn prepare_numeric_op_side_validities<T: ApolloNumericType>(
        &self,
        lhs: &mut PrimitiveArray<T::Native>,
        rhs: &mut PrimitiveArray<T::Native>,
        swapped: bool,
    ) where
        PrimitiveArray<T::Native>: apollo_compute::comparisons::TotalEqKernel<Scalar = T::Native>,
    ...
    fn apply_arithmetic_kernel<T: ApolloNumericType>(
        &self,
    ...
    /// a scalar.
    pub(super) fn apply_array_to_scalar<T: ApolloNumericType>(
        &self,

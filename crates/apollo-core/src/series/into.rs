...
use apollo_compute::cast::cast_default;
use apollo_compute::cast::cast_unchecked;
...
impl Series {
    ...
    /// This conversion is needed because apollo doesn't use a
        ...
        Ok(match dtype {
            ...
            DataType::Struct(fields) => {
                ...
                let expected_output_fields: &[ArrowField] = match output_arrow_field {
                    ...
                    Some(ArrowField { dtype, .. }) => apollo_bail!(
                        SchemaMismatch:

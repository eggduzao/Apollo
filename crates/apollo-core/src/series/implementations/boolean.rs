    ...
    fn and_reduce(&self) -> ApolloResult<Scalar> {
        ...
        Ok(Scalar::new(
            ...
            self.0
                ...
                .filter_map(apollo_compute::bitwise::BitwiseKernel::reduce_and)
                .reduce(|a, b| a & b)
    ...
    fn or_reduce(&self) -> ApolloResult<Scalar> {
        ...
        Ok(Scalar::new(
            ...
            self.0
                .downcast_iter()
                .filter(|arr| !arr.is_empty())
                .filter_map(apollo_compute::bitwise::BitwiseKernel::reduce_or)
                .reduce(|a, b| a | b)
                .map_or(AnyValue::Null, Into::into),
        ))
    }
    fn xor_reduce(&self) -> ApolloResult<Scalar> {
        ...
        Ok(Scalar::new(
            ...
            self.0
                .downcast_iter()
                .filter(|arr| !arr.is_empty())
                .filter_map(apollo_compute::bitwise::BitwiseKernel::reduce_xor)
                .reduce(|a, b| a ^ b)
                .map_or(AnyValue::Null, Into::into),
        ))
    }

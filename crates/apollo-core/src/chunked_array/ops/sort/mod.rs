...
fn arg_sort_multiple_numeric<T: ApolloNumericType>(
    ca: &ChunkedArray<T>,
    by: &[Column],
...
pub fn arg_sort(columns: &[Column], mut sort_options: SortMultipleOptions) -> ApolloResult<IdxCa> {
    ...
    if let [c] = columns {
        ...
        || std::env::var("APOLLO_ROW_FMT_SORT").is_ok()
    {

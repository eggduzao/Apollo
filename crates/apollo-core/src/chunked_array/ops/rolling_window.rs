...
use apollo_compute::rolling::RollingFnParams;
#[cfg(feature = "serde")]
...
mod inner_mod {
    ...
    /// utility
    fn check_input(window_size: usize, min_periods: usize) -> ApolloResult<()> {
        apollo_ensure!(
    ...
    impl<T: ApolloNumericType> ChunkRollApply for ChunkedArray<T> {

...
pub trait ApolloAsRef<T: ?Sized>: AsRef<T> {}

impl ApolloAsRef<str> for String {}
impl ApolloAsRef<str> for &str {}
// &["foo", "bar"]
impl ApolloAsRef<str> for &&str {}

impl ApolloAsRef<str> for Cow<'_, str> {}
impl ApolloAsRef<[u8]> for Vec<u8> {}
impl ApolloAsRef<[u8]> for &[u8] {}
// TODO: remove!
impl ApolloAsRef<[u8]> for &&[u8] {}
impl ApolloAsRef<[u8]> for Cow<'_, [u8]> {}
...
#[cfg(feature = "object")]
impl<T: ApolloObject> FromIterator<Option<T>> for ObjectChunked<T> {

...
use apollo_utils::min_max::{MaxIgnoreNan, MinIgnoreNan, MinMaxPolicy};
...
use crate::datatypes::{
    BinaryChunked, BooleanChunked, ApolloDataType, ApolloNumericType, StringChunked,
};
#[cfg(feature = "dtype-categorical")]
use crate::datatypes::{CategoricalChunked, ApolloCategoricalType};
...
#[cfg(feature = "dtype-categorical")]
pub fn arg_min_cat<T: ApolloCategoricalType>(ca: &CategoricalChunked<T>) -> Option<usize> {
    if ca.null_count() == ca.len() {
        return None;
    }
...
#[cfg(feature = "dtype-categorical")]
pub fn arg_max_cat<T: ApolloCategoricalType>(ca: &CategoricalChunked<T>) -> Option<usize> {
    if ca.null_count() == ca.len() {
        return None;
    }

...
use crate::datatypes::{
    ArrayCollectIterExt, ArrayFromIter, ArrayFromIterDtype, DataType, Field, ApolloDataType,
};
use crate::prelude::CompatLevel;

pub trait ChunkedCollectIterExt<T: ApolloDataType>: Iterator + Sized {
    #[inline]
...
impl<T: ApolloDataType, I: Iterator> ChunkedCollectIterExt<T> for I {}

pub trait ChunkedCollectInferIterExt<T: ApolloDataType>: Iterator + Sized {
    #[inline]
...
impl<T: ApolloDataType, I: Iterator> ChunkedCollectInferIterExt<T> for I {}

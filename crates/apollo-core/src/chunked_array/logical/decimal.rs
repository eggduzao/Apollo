...
use apollo_compute::decimal::{dec128_fits, dec128_rescale, dec128_verify_prec_scale};
...
impl Int128Chunked {
    ...
    pub fn into_decimal(self, precision: usize, scale: usize) -> ApolloResult<DecimalChunked> {

...
use super::from_iterator::ApolloAsRef;
    ...
    I: IntoParallelIterator,
{
    ...
    // needed
    // https://github.com/apollo/apollo/issues/1562
...
where
    Ptr: ApolloAsRef<str> + Send + Sync + NoOption,
{
...
where
    Ptr: ApolloAsRef<[u8]> + Send + Sync + NoOption,
{
    fn from_par_iter<I: IntoParallelIterator<Item = Ptr>>(iter: I) -> Self {
        let chunks = collect_into_linked_list(iter, MutableBinaryViewArray::new);
        Self::from_chunk_iter(PlSmallStr::EMPTY, chunks).optional_rechunk()
...
pub fn list_from_par_iter<I>(par_iter: I, name: PlSmallStr) -> ApolloResult<ListChunked>
where
    I: IntoParallelIterator<Item = Option<Series>>,
{
...
pub fn try_list_from_par_iter<I>(par_iter: I, name: PlSmallStr) -> ApolloResult<ListChunked>
where
    I: IntoParallelIterator<Item = ApolloResult<Option<Series>>>,
{

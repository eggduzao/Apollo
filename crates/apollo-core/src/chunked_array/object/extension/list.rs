...
pub(crate) struct ExtensionListBuilder<T: ApolloObject> {
    values_builder: ObjectChunkedBuilder<T>,
    offsets: Vec<i64>,
    fast_explode: bool,
}

impl<T: ApolloObject> ExtensionListBuilder<T> {
...
impl<T: ApolloObject> ListBuilderTrait for ExtensionListBuilder<T> {
    ...
    fn finish(&mut self) -> ListChunked {
        ...
        // SAFETY: this is safe because we just created the ApolloExtension

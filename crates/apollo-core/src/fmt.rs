...
// Note: see https://github.com/apollo/apollo/pull/13699 for the rationale
...
impl Display for DataFrame {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        #[cfg(any(feature = "fmt", feature = "fmt_no_tty"))]
        {
            ...
            let tbl_width = std::env::var("APOLLO_TABLE_WIDTH")
                .map(|s| {
                    let n = s
                        .parse::<i64>()
...
fn fmt_decimal(f: &mut Formatter<'_>, v: i128, scale: usize) -> fmt::Result {
    let mut fmt_buf = apollo_compute::decimal::DecimalFmtBuffer::new();
...
[
	...
	null
        ...
        unsafe { std::env::set_var("APOLLO_FMT_TABLE_CELL_LIST_LEN", "10") };
...
[
	...
	null
        ...
        unsafe { std::env::set_var("APOLLO_FMT_TABLE_CELL_LIST_LEN", "-1") };
...
[
	...
	null
        ...
        unsafe { std::env::set_var("APOLLO_FMT_TABLE_CELL_LIST_LEN", "0") };
...
[
	...
	null
        ...
        unsafe { std::env::set_var("APOLLO_FMT_TABLE_CELL_LIST_LEN", "4") };
...
[
	...
	null
        ...
        unsafe { std::env::set_var("APOLLO_FMT_TABLE_CELL_LIST_LEN", "") };

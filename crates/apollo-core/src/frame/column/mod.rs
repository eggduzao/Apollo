...
use apollo_compute::rolling::QuantileMethod;
use apollo_error::ApolloResult;
use apollo_utils::aliases::PlSeedableRandomStateQuality;
...
impl Column {
    ...
    pub fn new_row_index(name: PlSmallStr, offset: IdxSize, length: usize) -> ApolloResult<Column> {
    ...
    pub fn try_cat<T: ApolloCategoricalType>(&self) -> Option<&CategoricalChunked<T>> {
    ...
    // # To Chunked Arrays
    pub fn bool(&self) -> ApolloResult<&BooleanChunked> {
        self.as_materialized_series().bool()
    }
    pub fn i8(&self) -> ApolloResult<&Int8Chunked> {
        self.as_materialized_series().i8()
    }
    pub fn i16(&self) -> ApolloResult<&Int16Chunked> {
        self.as_materialized_series().i16()
    }
    pub fn i32(&self) -> ApolloResult<&Int32Chunked> {
        self.as_materialized_series().i32()
    }
    pub fn i64(&self) -> ApolloResult<&Int64Chunked> {
        self.as_materialized_series().i64()
    }
    #[cfg(feature = "dtype-i128")]
    pub fn i128(&self) -> ApolloResult<&Int128Chunked> {
        self.as_materialized_series().i128()
    }
    pub fn u8(&self) -> ApolloResult<&UInt8Chunked> {
        self.as_materialized_series().u8()
    }
    pub fn u16(&self) -> ApolloResult<&UInt16Chunked> {
        self.as_materialized_series().u16()
    }
    pub fn u32(&self) -> ApolloResult<&UInt32Chunked> {
        self.as_materialized_series().u32()
    }
    pub fn u64(&self) -> ApolloResult<&UInt64Chunked> {
        self.as_materialized_series().u64()
    }
    #[cfg(feature = "dtype-u128")]
    pub fn u128(&self) -> ApolloResult<&UInt128Chunked> {
        self.as_materialized_series().u128()
    }
    #[cfg(feature = "dtype-f16")]
    pub fn f16(&self) -> ApolloResult<&Float16Chunked> {
        self.as_materialized_series().f16()
    }
    pub fn f32(&self) -> ApolloResult<&Float32Chunked> {
        self.as_materialized_series().f32()
    }
    pub fn f64(&self) -> ApolloResult<&Float64Chunked> {
        self.as_materialized_series().f64()
    }
    pub fn str(&self) -> ApolloResult<&StringChunked> {
        self.as_materialized_series().str()
    }
    pub fn list(&self) -> ApolloResult<&ListChunked> {
        self.as_materialized_series().list()
    }
    pub fn binary(&self) -> ApolloResult<&BinaryChunked> {
        self.as_materialized_series().binary()
    }
    pub fn idx(&self) -> ApolloResult<&IdxCa> {
        self.as_materialized_series().idx()
    }
    pub fn binary_offset(&self) -> ApolloResult<&BinaryOffsetChunked> {
        self.as_materialized_series().binary_offset()
    }
    #[cfg(feature = "dtype-datetime")]
    pub fn datetime(&self) -> ApolloResult<&DatetimeChunked> {
        self.as_materialized_series().datetime()
    }
    #[cfg(feature = "dtype-struct")]
    pub fn struct_(&self) -> ApolloResult<&StructChunked> {
        self.as_materialized_series().struct_()
    }
    #[cfg(feature = "dtype-decimal")]
    pub fn decimal(&self) -> ApolloResult<&DecimalChunked> {
        self.as_materialized_series().decimal()
    }
    #[cfg(feature = "dtype-array")]
    pub fn array(&self) -> ApolloResult<&ArrayChunked> {
        self.as_materialized_series().array()
    }
    #[cfg(feature = "dtype-categorical")]
    pub fn cat<T: ApolloCategoricalType>(&self) -> ApolloResult<&CategoricalChunked<T>> {
        self.as_materialized_series().cat::<T>()
    }
    #[cfg(feature = "dtype-categorical")]
    pub fn cat8(&self) -> ApolloResult<&Categorical8Chunked> {
        self.as_materialized_series().cat8()
    }
    #[cfg(feature = "dtype-categorical")]
    pub fn cat16(&self) -> ApolloResult<&Categorical16Chunked> {
        self.as_materialized_series().cat16()
    }
    #[cfg(feature = "dtype-categorical")]
    pub fn cat32(&self) -> ApolloResult<&Categorical32Chunked> {
        self.as_materialized_series().cat32()
    }
    #[cfg(feature = "dtype-date")]
    pub fn date(&self) -> ApolloResult<&DateChunked> {
        self.as_materialized_series().date()
    }
    #[cfg(feature = "dtype-duration")]
    pub fn duration(&self) -> ApolloResult<&DurationChunked> {
        self.as_materialized_series().duration()
    }

    // # Casting
    pub fn cast_with_options(&self, dtype: &DataType, options: CastOptions) -> ApolloResult<Self> {
        match self {
    ...
    pub fn strict_cast(&self, dtype: &DataType) -> ApolloResult<Self> {
        match self {
            Column::Series(s) => s.strict_cast(dtype).map(Column::from),
            Column::Scalar(s) => s.strict_cast(dtype).map(Column::from),
        }
    }
    pub fn cast(&self, dtype: &DataType) -> ApolloResult<Column> {
        match self {
    ...
    pub unsafe fn cast_unchecked(&self, dtype: &DataType) -> ApolloResult<Column> {
        match self {
    ...
    ///
    /// This can lead to invalid memory access in downstream code.
    pub unsafe fn from_physical_unchecked(&self, dtype: &DataType) -> ApolloResult<Column> {
        // @scalar-opt
        self.as_materialized_series()
    ...
    pub fn take(&self, indices: &IdxCa) -> ApolloResult<Column> {
        check_bounds_ca(indices, self.len() as IdxSize)?;
        Ok(unsafe { self.take_unchecked(indices) })
    }
    pub fn take_slice(&self, indices: &[IdxSize]) -> ApolloResult<Column> {
    ...
    pub fn append(&mut self, other: &Column) -> ApolloResult<&mut Self> {
        // @scalar-opt
        self.into_materialized_series()
            .append(other.as_materialized_series())?;
        Ok(self)
    }
    pub fn append_owned(&mut self, other: Column) -> ApolloResult<&mut Self> {
        self.into_materialized_series()
    ...
    pub fn arg_unique(&self) -> ApolloResult<IdxCa> {
        match self {
    ...
    pub fn extend(&mut self, other: &Column) -> ApolloResult<&mut Self> {
        // @scalar-opt
        self.into_materialized_series()
    ...
    pub fn explode(&self, options: ExplodeOptions) -> ApolloResult<Column> {
        self.as_materialized_series()
            .explode(options)
            .map(Column::from)
    }
    pub fn implode(&self) -> ApolloResult<ListChunked> {
        self.as_materialized_series().implode()
    }

    pub fn fill_null(&self, strategy: FillNullStrategy) -> ApolloResult<Self> {
        // @scalar-opt
        self.as_materialized_series()
            .fill_null(strategy)
            .map(Column::from)
    ...
    pub fn divide(&self, rhs: &Column) -> ApolloResult<Self> {
        // @scalar-opt
        self.as_materialized_series()
    ...
    pub fn zip_with(&self, mask: &BooleanChunked, other: &Self) -> ApolloResult<Self> {
        // @scalar-opt
        self.as_materialized_series()
    ...
    pub fn unique(&self) -> ApolloResult<Column> {
        match self {
    ...
    pub fn unique_stable(&self) -> ApolloResult<Column> {
        match self {
    ...
    pub fn reshape_list(&self, dimensions: &[ReshapeDimension]) -> ApolloResult<Self> {
        // @scalar-opt
        self.as_materialized_series()
    ...
    #[cfg(feature = "dtype-array")]
    pub fn reshape_array(&self, dimensions: &[ReshapeDimension]) -> ApolloResult<Self> {
        // @scalar-opt
        self.as_materialized_series()
    ...
    pub fn sort(&self, sort_options: SortOptions) -> ApolloResult<Self> {
        // @scalar-opt
        self.as_materialized_series()
            .sort(sort_options)
            .map(Self::from)
    ...
    pub fn filter(&self, filter: &BooleanChunked) -> ApolloResult<Self> {
        match self {
    ...
    pub fn gather_every(&self, n: usize, offset: usize) -> ApolloResult<Column> {
        apollo_ensure!(n > 0, InvalidOperation: "gather_every(n): n should be positive");
    ...
    pub fn extend_constant(&self, value: AnyValue, n: usize) -> ApolloResult<Self> {
        if self.is_empty() {
    ...
    pub fn is_finite(&self) -> ApolloResult<BooleanChunked> {
        self.try_map_unary_elementwise_to_bool(|s| s.is_finite())
    }
    pub fn is_infinite(&self) -> ApolloResult<BooleanChunked> {
        self.try_map_unary_elementwise_to_bool(|s| s.is_infinite())
    }
    pub fn is_nan(&self) -> ApolloResult<BooleanChunked> {
        self.try_map_unary_elementwise_to_bool(|s| s.is_nan())
    }
    pub fn is_not_nan(&self) -> ApolloResult<BooleanChunked> {
    ...
    pub fn product(&self) -> ApolloResult<Scalar> {
        // @scalar-opt
    ...
    #[inline]
    pub fn get(&self, index: usize) -> ApolloResult<AnyValue<'_>> {
        apollo_ensure!(index < self.len(), oob = index, self.len());
    ...
    pub fn get_object(
        &self,
        index: usize,
    ) -> Option<&dyn crate::chunked_array::object::ApolloObjectSafe> {
        self.as_materialized_series().get_object(index)
    }

    pub fn bitand(&self, rhs: &Self) -> ApolloResult<Self> {
        self.try_apply_broadcasting_binary_elementwise(rhs, |l, r| l & r)
    }
    pub fn bitor(&self, rhs: &Self) -> ApolloResult<Self> {
        self.try_apply_broadcasting_binary_elementwise(rhs, |l, r| l | r)
    }
    pub fn bitxor(&self, rhs: &Self) -> ApolloResult<Self> {
        self.try_apply_broadcasting_binary_elementwise(rhs, |l, r| l ^ r)
    }

    pub fn try_add_owned(self, other: Self) -> ApolloResult<Self> {
        match (self, other) {
    ...
    pub fn try_sub_owned(self, other: Self) -> ApolloResult<Self> {
        match (self, other) {
            (Column::Series(lhs), Column::Series(rhs)) => {
    ...
    pub fn try_mul_owned(self, other: Self) -> ApolloResult<Self> {
        match (self, other) {
            (Column::Series(lhs), Column::Series(rhs)) => {
    ...
    pub(crate) fn str_value(&self, index: usize) -> ApolloResult<Cow<'_, str>> {
        Ok(self.get(index)?.str_value())
    }

    pub fn min_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn max_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn median_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn mean_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn std_reduce(&self, ddof: u8) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn var_reduce(&self, ddof: u8) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn sum_reduce(&self) -> ApolloResult<Scalar> {
        // @scalar-opt
        self.as_materialized_series().sum_reduce()
    }
    pub fn and_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn or_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn xor_reduce(&self) -> ApolloResult<Scalar> {
        match self {
    ...
    pub fn n_unique(&self) -> ApolloResult<usize> {
        match self {
    ...
    pub fn quantile_reduce(&self, quantile: f64, method: QuantileMethod) -> ApolloResult<Scalar> {
        self.as_materialized_series()
    ...
    pub fn sort_with(&self, options: SortOptions) -> ApolloResult<Self> {
        match self {
    ...
    pub fn try_map_unary_elementwise_to_bool(
        &self,
        f: impl Fn(&Series) -> ApolloResult<BooleanChunked>,
    ) -> ApolloResult<BooleanChunked> {
        match self {
            Column::Series(s) => f(s),
    ...
    pub fn try_apply_unary_elementwise(
        &self,
        f: impl Fn(&Series) -> ApolloResult<Series>,
    ) -> ApolloResult<Column> {
        match self {
    ...
    pub fn try_apply_broadcasting_binary_elementwise(
        &self,
        other: &Self,
        op: impl Fn(&Series, &Series) -> ApolloResult<Series>,
    ) -> ApolloResult<Column> {
        fn output_length(a: &Column, b: &Column) -> ApolloResult<usize> {
            match (a.len(), b.len()) {
                // broadcasting
                (1, o) | (o, 1) => Ok(o),
                // equal
                ...
                // unequal
                (a, b) => {
                    apollo_bail!(InvalidOperation: "cannot do a binary operation on columns of different lengths: got {} and {}", a, b)
                },
            }
        }
    ...
    pub fn try_apply_binary_elementwise(
        &self,
        other: &Self,
        f: impl Fn(&Series, &Series) -> ApolloResult<Series>,
        f_lb: impl Fn(&Scalar, &Series) -> ApolloResult<Series>,
        f_rb: impl Fn(&Series, &Scalar) -> ApolloResult<Series>,
    ) -> ApolloResult<Column> {
    ...
    pub fn approx_n_unique(&self) -> ApolloResult<IdxSize> {
        match self {
    ...
    pub fn unique_id(&self) -> ApolloResult<(IdxSize, Vec<IdxSize>)> {

...
impl ChunkCompareEq<&Column> for Column {
    ...
    #[inline]
    fn equal(&self, rhs: &Column) -> ApolloResult<BooleanChunked> {
        column_element_wise_broadcasting!(self, rhs, <Series as ChunkCompareEq<&Series>>::equal)
    }

    /// Create a boolean mask by checking for equality.
    #[inline]
    fn equal_missing(&self, rhs: &Column) -> ApolloResult<BooleanChunked> {
    ...
    #[inline]
    fn not_equal(&self, rhs: &Column) -> ApolloResult<BooleanChunked> {
        column_element_wise_broadcasting!(self, rhs, <Series as ChunkCompareEq<&Series>>::not_equal)
    }

    /// Create a boolean mask by checking for inequality.
    #[inline]
    fn not_equal_missing(&self, rhs: &Column) -> ApolloResult<BooleanChunked> {
        column_element_wise_broadcasting!(
            self,
            rhs,

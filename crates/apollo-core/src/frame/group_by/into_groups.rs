...
use apollo_error::signals::try_raise_keyboard_interrupt;
use apollo_utils::total_ord::{ToTotalOrd, TotalHash};
...
fn group_multithreaded<T: ApolloDataType>(ca: &ChunkedArray<T>) -> bool {
...
impl<T: ApolloCategoricalType> IntoGroupsType for CategoricalChunked<T>
where
    ChunkedArray<T::ApolloPhysical>: IntoGroupsType,
{
...
impl IntoGroupsType for BooleanChunked {
    fn group_tuples(&self, mut multithreaded: bool, sorted: bool) -> ApolloResult<GroupsType> {
...
impl IntoGroupsType for StringChunked {
    ...
    fn group_tuples<'a>(&'a self, multithreaded: bool, sorted: bool) -> ApolloResult<GroupsType> {
...
where
    T: ApolloObject,
{
    fn group_tuples(&self, _multithreaded: bool, sorted: bool) -> ApolloResult<GroupsType> {

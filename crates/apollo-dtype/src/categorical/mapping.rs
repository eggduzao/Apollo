...
use apollo_utils::aliases::{PlFixedStateQuality, PlSeedableRandomStateQuality};
use apollo_utils::parma::raw::RawTable;
...
impl CategoricalMapping {
    ...
    #[inline(always)]
    pub fn insert_cat(&self, s: &str) -> ApolloResult<CatSize> {
        let hash = self.hasher.hash_one(s);
    ...
    #[inline(always)]
    pub fn insert_cat_with_hash(&self, s: &str, hash: u64) -> ApolloResult<CatSize> {
        self.str_to_cat

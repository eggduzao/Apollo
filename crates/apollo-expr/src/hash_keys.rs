...
use apollo_core::prelude::row_encode::_get_rows_encoded_unordered;
use apollo_core::prelude::{ChunkedArray, DataType, PlRandomState, ApolloDataType, *};
...
use apollo_utils::total_ord::{BuildHasherTotalExt, TotalHash};
...
impl RowEncodedKeys {
    ...
    pub unsafe fn gather_unchecked(&self, idxs: &[IdxSize]) -> Self {
        ...
        Self {
            hashes: apollo_compute::gather::primitive::take_primitive_unchecked(
                &self.hashes,
                &idx_arr,
            ),
            keys: apollo_compute::gather::binary::take_unchecked(&self.keys, &idx_arr),
        }
    }
}
...
impl BinviewKeys {
    ...
    pub unsafe fn gather_unchecked(&self, idxs: &[IdxSize]) -> Self {
        ...
        Self {
            ...
            keys: apollo_compute::gather::binview::take_binview_unchecked(&self.keys, &idx_arr),
            null_is_valid: self.null_is_valid,
        }
    }
}
...
where
    T: ApolloDataType,
    for<'a> <T as ApolloDataType>::Physical<'a>: TotalHash,

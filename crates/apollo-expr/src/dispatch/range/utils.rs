use apollo_core::prelude::{
    ...
    ApolloIntegerType, ApolloNumericType, ApolloResult, apollo_bail, apollo_ensure,
};
...
where
    T: ApolloIntegerType,
    U: ApolloIntegerType,
    F: Fn(T::Native, T::Native, i64, &mut ListPrimitiveChunkedBuilder<U>) -> ApolloResult<()>,
...
where
    T: ApolloIntegerType,
    U: ApolloIntegerType,
    F: Fn(T::Native, T::Native, &mut ListPrimitiveChunkedBuilder<U>) -> ApolloResult<()>,
    ListPrimitiveChunkedBuilder<U>: ListBuilderTrait,
{

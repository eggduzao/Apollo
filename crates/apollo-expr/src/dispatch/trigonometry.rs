...
use apollo_core::chunked_array::ops::arity::broadcast_binary_elementwise;
use apollo_core::error::{ApolloResult, apollo_bail};
use apollo_core::prelude::*;
use apollo_plan::plans::IRTrigonometricFunction;
...
pub(super) fn apply_trigonometric_function(
    ...
    match s.dtype() {
        ...
        dt => apollo_bail!(op = "trigonometry", dt),
    }
}

pub(super) fn apply_arctan2(s: &mut [Column]) -> ApolloResult<Column> {
    let y = &s[0];
    let x = &s[1];
...
fn arctan2_on_columns(y: &Column, x: &Column) -> ApolloResult<Column> {
    use DataType::*;
    match y.dtype() {
        #[cfg(feature = "dtype-f16")]
        Float16 => {
...
fn arctan2_on_floats<T>(y: &ChunkedArray<T>, x: &Column) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
...
fn cos<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn cot<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn sin<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn tan<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn arccos<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn arcsin<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn arctan<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn cosh<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn sinh<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn tanh<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn arccosh<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn arcsinh<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn arctanh<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn degrees<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,
...
fn radians<T>(ca: &ChunkedArray<T>) -> ApolloResult<Column>
where
    T: ApolloFloatType,
    T::Native: Float,
    ChunkedArray<T>: IntoColumn,

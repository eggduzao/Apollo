...
use apollo_ops::prelude::ChunkJoinOptIds;
...
impl ExecutionState {
    ...
    pub fn finish_timer(self) -> ApolloResult<DataFrame> {
    ...
    pub fn should_stop(&self) -> ApolloResult<()> {
        try_raise_keyboard_interrupt();
        apollo_ensure!(!self.stop.load(), ComputeError: "query interrupted");
        Ok(())
    }

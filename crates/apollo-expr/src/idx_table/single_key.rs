...
use apollo_utils::idx_map::total_idx_map::{Entry, TotalIndexMap};
use apollo_utils::idx_vec::UnitVec;
...
pub struct SingleKeyIdxTable<T: ApolloDataType> {
...
impl<T: ApolloDataType> SingleKeyIdxTable<T> {
    pub fn new() -> Self {
        Self {
...
where
    for<'a> T: ApolloDataType<Physical<'a> = K>,

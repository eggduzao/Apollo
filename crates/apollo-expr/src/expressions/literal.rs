...
impl LiteralExpr {
    ...
    fn as_column(&self) -> ApolloResult<Column> {
        ...
        let column = match &self.0 {
            ...
            lv @ L::Dyn(_) => apollo_core::prelude::Series::from_any_values(
                get_literal_name(),
...
impl PhysicalExpr for LiteralExpr {
    ...
    fn evaluate(&self, _df: &DataFrame, _state: &ExecutionState) -> ApolloResult<Column> {
        self.as_column()
    }

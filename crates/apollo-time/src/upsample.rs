...
use apollo_core::datatypes::time_zone::parse_time_zone;
...
pub trait ApolloUpsample {
    ...
    /// Upsample a [`DataFrame`] at a regular frequency.
    ///
    /// Similar to [`upsample`][ApolloUpsample::upsample], but order of the
...
impl ApolloUpsample for DataFrame {
    fn upsample<I: IntoVec<PlSmallStr>>(
        &self,
        by: I,
        time_column: &str,

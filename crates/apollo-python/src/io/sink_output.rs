use apollo::prelude::file_provider::{FileProviderFunction, FileProviderType};
use apollo::prelude::{PartitionStrategy, PlRefPath, SinkDestination, SpecialEq};
...
impl PyFileSinkDestination<'_> {
    pub fn extract_file_sink_destination(&self) -> PyResult<SinkDestination> {
        ...
        let v: Wrap<apollo_plan::dsl::SinkTarget> = self.0.extract()?;

use apollo_testing::asserts::{DataFrameEqualOptions, assert_dataframe_equal};
use pyo3::prelude::*;
...
pub fn assert_dataframe_equal_py(
    ...
    assert_dataframe_equal(left_df, right_df, options).map_err(|e| PyApolloErr::from(e).into())
}

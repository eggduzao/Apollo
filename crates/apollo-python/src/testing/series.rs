use apollo_testing::asserts::{SeriesEqualOptions, assert_series_equal};
use pyo3::prelude::*;
...
pub fn assert_series_equal_py(
    ...
    assert_series_equal(left_series, right_series, options).map_err(|e| PyApolloErr::from(e).into())
}

...
use apollo::datatypes::CompatLevel;
use apollo::frame::DataFrame;
use apollo::prelude::{ArrayRef, ArrowField, PlSmallStr, SchemaExt};
use apollo::series::Series;
use apollo_core::utils::arrow;
...
#[cfg(feature = "c_api")]
#[pyfunction]
pub(crate) fn apollo_schema_to_pycapsule<'py>(
    py: Python<'py>,
    schema: crate::prelude::Wrap<apollo::prelude::Schema>,

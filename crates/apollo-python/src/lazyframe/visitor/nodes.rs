#[cfg(feature = "iejoin")]
use apollo::prelude::JoinTypeOptionsIR;
use apollo::prelude::deletion::DeletionFilesList;
use apollo::prelude::python_dsl::PythonScanSource;
use apollo::prelude::{ColumnMapping, PredicateFileSkip};
use apollo_core::prelude::IdxSize;
use apollo_io::cloud::CloudOptions;
use apollo_ops::prelude::JoinType;
use apollo_plan::plans::{HintIR, IR};
use apollo_plan::prelude::{FileScanIR, FunctionIR, PythonPredicate, UnifiedScanArgs};
            ...
            PythonScan {
                options: (
                    ...
                    match &options.predicate {
                        ...
                        PythonPredicate::Apollo(e) => ("apollo", e.node().0).into_py_any(py)?,
                    },
                    options
                        .n_rows

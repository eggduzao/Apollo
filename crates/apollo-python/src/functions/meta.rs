...
use apollo_core::fmt::FloatFmt;
use apollo_core::prelude::IDX_DTYPE;
...
pub fn set_float_fmt(fmt: &str) -> PyResult<()> {
    ...
    apollo_core::fmt::set_float_fmt(fmt);
    Ok(())
}

#[pyfunction]
pub fn get_float_fmt() -> PyResult<String> {
    let strfmt = match apollo_core::fmt::get_float_fmt() {
        FloatFmt::Full => "full",
...
pub fn set_float_precision(precision: Option<usize>) -> PyResult<()> {
    use apollo_core::fmt::set_float_precision;
...
pub fn get_float_precision() -> PyResult<Option<usize>> {
    use apollo_core::fmt::get_float_precision;
...
pub fn set_thousands_separator(sep: Option<char>) -> PyResult<()> {
    use apollo_core::fmt::set_thousands_separator;
...
pub fn get_thousands_separator() -> PyResult<Option<String>> {
    use apollo_core::fmt::get_thousands_separator;
...
pub fn set_decimal_separator(sep: Option<char>) -> PyResult<()> {
    use apollo_core::fmt::set_decimal_separator;
...
pub fn get_decimal_separator() -> PyResult<Option<char>> {
    use apollo_core::fmt::get_decimal_separator;
...
pub fn set_trim_decimal_zeros(trim: Option<bool>) -> PyResult<()> {
    use apollo_core::fmt::set_trim_decimal_zeros;
...
pub fn get_trim_decimal_zeros() -> PyResult<Option<bool>> {
    use apollo_core::fmt::get_trim_decimal_zeros;

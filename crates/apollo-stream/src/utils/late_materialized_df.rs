...
use apollo_plan::dsl::{FileScanIR, ScanSources};
use apollo_plan::plans::{AnonymousScan, AnonymousScanArgs, FileInfo, IR};
use apollo_plan::prelude::{AnonymousScanOptions, UnifiedScanArgs};
...
impl AnonymousScan for LateMaterializedDataFrame {
    ...
    fn scan(&self, _scan_opts: AnonymousScanArgs) -> ApolloResult<DataFrame> {

...
use apollo_plan::dsl::PartitionStrategyIR;
use apollo_plan::plans::expr_ir::ExprIR;
use apollo_plan::plans::{AExpr, EscapeLabel};
use apollo_plan::prelude::FileWriteFormat;
use apollo_time::ClosedWindow;
...
fn visualize_plan_rec(
    ...
    let (label, inputs) = match kind {
        ...
        PhysNodeKind::DynamicGroupBy {
            ...
            use apollo_time::prelude::{Label, StartBy};

...
use apollo_core::frame::{DataFrame, UniqueKeepStrategy};
use apollo_core::prelude::{DataType, PlHashMap, PlHashSet};
use apollo_core::scalar::Scalar;
use apollo_core::schema::Schema;
use apollo_core::{SchemaExtPl, config};
use apollo_error::ApolloResult;
use apollo_expr::state::ExecutionState;
use apollo_mem_engine::create_physical_plan;
use apollo_plan::constants::get_literal_name;
use apollo_plan::dsl::default_values::DefaultFieldValues;
use apollo_plan::dsl::deletion::DeletionFilesList;
use apollo_plan::dsl::{CallbackSinkType, ExtraColumnsPolicy, FileScanIR, SinkTypeIR};
use apollo_plan::plans::expr_ir::{ExprIR, OutputName};
use apollo_plan::plans::{
...
use apollo_utils::row_counter::RowCounter;
use apollo_utils::slice_enum::Slice;
use apollo_utils::unique_id::UniqueId;
use apollo_utils::{IdxSize, format_pl_smallstr, unique_column_name};
use slotmap::SlotMap;
...
pub fn lower_ir(
    ...
    let node_kind = match ir_node {
        ...
        IR::MergeSorted {
            ...
            use apollo_plan::plans::{AExprBuilder, RowEncodingVariant};
        ...
        v @ IR::PythonScan { options } => {
            use apollo_plan::dsl::python_dsl::PythonScanSource;
        ...
        IR::Distinct { input, options } => {
            ...
            if options.keep_strategy == UniqueKeepStrategy::None {
                ...
                let predicate_aexpr = expr_arena.add(AExpr::BinaryExpr {
                    left,
                    op: apollo_plan::dsl::Operator::Eq,
                    right,
                });
                let predicate =

...
pub async fn read_parquet_metadata_bytes(
    ...
    use apollo_parquet::parquet::PARQUET_MAGIC;
    use apollo_parquet::parquet::error::ParquetError;

    const FOOTER_HEADER_SIZE: usize = apollo_parquet::parquet::FOOTER_SIZE as usize;

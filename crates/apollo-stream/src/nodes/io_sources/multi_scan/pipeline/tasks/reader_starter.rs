...
use apollo_core::prelude::{AnyValue, DataType};
use apollo_core::scalar::Scalar;
use apollo_core::schema::iceberg::IcebergSchema;
use apollo_error::ApolloResult;
use apollo_mem_engine::scan_predicate::skip_files_mask::SkipFilesMask;
use apollo_plan::dsl::{MissingColumnsPolicy, ScanSource};
...
pub struct ReaderStarter {
    ...
    pub readers_init_iter: BoxStream<'static, ApolloResult<InitializedReaderState>>,
    pub n_sources: usize,
    pub started_reader_tx: tokio::sync::mpsc::Sender<(
        AbortOnDropHandle<ApolloResult<StartedReaderState>>,
        WaitToken,
    )>,
            ...
            if let Some(skip_read_reason) = skip_read_reason {
                ...
                if should_update_row_position {
                    ...
                    let get_row_count = async {
                        ...
                        ApolloResult::Ok(file_row_count)
                    };
...
) -> ApolloResult<StartedReaderState> {

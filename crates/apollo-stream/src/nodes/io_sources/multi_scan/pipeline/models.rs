...
use apollo_plan::dsl::{CastColumnsPolicy, MissingColumnsPolicy, ScanSource};
...
pub struct InitializedPipelineState {
    pub task_handle: AbortOnDropHandle<ApolloResult<()>>,
...
pub(super) struct StartedReaderState {
    ...
    pub(super) post_apply_pipeline_handle: Option<AbortOnDropHandle<ApolloResult<()>>>,
    pub(super) reader_handle: AbortOnDropHandle<ApolloResult<()>>,
}

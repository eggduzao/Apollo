...
use apollo_core::utils::arrow::io::ipc::read::{
    BlockReader, FileMetadata, ProjectionInfo, prepare_projection, read_file_metadata,
};
use apollo_error::{ErrString, ApolloError, ApolloResult};
use apollo_io::cloud::CloudOptions;
use apollo_io::ipc::IpcScanOptions;
use apollo_io::pl_async;
use apollo_io::utils::byte_source::{
...
const ROW_COUNT_OVERFLOW_ERR: ApolloError = ApolloError::ComputeError(ErrString::new_static(
    "\
...
impl FileReader for IpcFileReader {
    ...
    fn begin_read(
        ...
        let io_runtime = apollo_io::pl_async::get_runtime();

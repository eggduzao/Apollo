...
use apollo_parquet::read::ParquetError;
...
pub struct RowGroupEncoder {
    ...
    pub encoded_row_group_tx:
        tokio::sync::mpsc::Sender<async_executor::AbortOnDropHandle<ApolloResult<EncodedRowGroup>>>,

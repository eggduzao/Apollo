...
use apollo_plan::dsl::file_provider::{FileProviderReturn, FileProviderType};
use apollo_plan::prelude::file_provider::FileProviderArgs;
...
impl FileProvider {
    pub async fn open_file(&self, args: FileProviderArgs) -> ApolloResult<Writeable> {

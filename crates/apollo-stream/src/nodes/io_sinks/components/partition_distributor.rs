...
use apollo_core::prelude::{InitHashMaps, PlHashSet, PlIndexMap};
use apollo_error::ApolloResult;
use apollo_plan::dsl::file_provider::FileProviderArgs;
...
pub struct PartitionDistributor {
    ...
    pub partitioned_dfs_rx: tokio::sync::mpsc::Receiver<
        async_executor::AbortOnDropHandle<ApolloResult<PartitionedDataFrames>>,
    >,

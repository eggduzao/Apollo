...
impl ComputeNode for IOSinkNode {
    ...
    fn spawn<'env, 's>(
        ...
        join_handles: &mut Vec<crate::async_executor::JoinHandle<apollo_error::ApolloResult<()>>>,
    ) {
...
enum IOSinkNodeState {
    ...
    Initialized {
        ...
        task_handle: async_executor::AbortOnDropHandle<ApolloResult<()>>,
    },

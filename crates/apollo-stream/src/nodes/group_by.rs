...
use apollo_core::prelude::{IntoColumn, PlHashSet, PlRandomState};
use apollo_core::schema::Schema;
use apollo_core::utils::accumulate_dataframes_vertical_unchecked;
use apollo_expr::groups::Grouper;
use apollo_expr::hash_keys::HashKeys;
use apollo_expr::hot_groups::{HotGrouper, new_hash_hot_grouper};
use apollo_expr::reduce::GroupedReduction;
...
impl GroupBySinkState {
    ...
    fn combine_locals(&mut self) -> ApolloResult<Vec<GroupByPartition>> {
...
impl GroupByPartition {
    fn into_df(self, key_schema: &Schema, output_schema: &Schema) -> ApolloResult<DataFrame> {
...
impl GroupByNode {
    ...
    pub fn new(
        ...
        let hot_table_size = std::env::var("APOLLO_HOT_TABLE_SIZE")

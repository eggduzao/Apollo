...
fn test_agg_list_type() -> ApolloResult<()> {
...
#[test]
fn test_agg_exprs() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_agg_unique_first() -> ApolloResult<()> {
    let df = df![
        "g"=> [1, 1, 2, 2, 3, 4, 1],
        "v"=> [1, 2, 2, 2, 3, 4, 1],
    ]?;
...
#[test]
#[cfg(feature = "cum_agg")]
fn test_cum_sum_agg_as_key() -> ApolloResult<()> {
    let df = df![
...
#[test]
#[cfg(feature = "moment")]
fn test_auto_skew_kurtosis_agg() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_auto_list_agg() -> ApolloResult<()> {
    let df = fruits_cars();
...
fn test_power_in_agg_list1() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
#[cfg(feature = "rolling_window")]
fn test_power_in_agg_list2() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_binary_agg_context_0() -> ApolloResult<()> {
    let df = df![
        "groups" => [1, 1, 2, 2, 3, 3],
        "vals" => [1, 2, 3, 4, 5, 6]
    ]
...
#[test]
fn test_binary_agg_context_1() -> ApolloResult<()> {
    let df = df![
        "groups" => [1, 1, 2, 2, 3, 3],
        "vals" => [1, 13, 3, 87, 1, 6]
    ]?;
...
#[test]
fn test_binary_agg_context_2() -> ApolloResult<()> {
    let df = df![
        "groups" => [1, 1, 2, 2, 3, 3],
        "vals" => [1, 2, 3, 4, 5, 6]
    ]?;
...
#[test]
fn test_binary_agg_context_3() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_shift_elementwise_issue_2509() -> ApolloResult<()> {
    let df = df![
        "x"=> [0, 0, 0, 1, 1, 1, 2, 2, 2],
...
#[test]
fn take_aggregations() -> ApolloResult<()> {
    let df = df![
...
#[test]
fn test_take_consistency() -> ApolloResult<()> {
    let df = fruits_cars();
    let out = df
        .clone()
        .lazy()
...
#[test]
fn test_take_in_groups() -> ApolloResult<()> {
    let df = fruits_cars();
...
fn test_anonymous_function_returns_scalar_all_null_20679() {
    ...
    fn reduction_function(column: Column) -> ApolloResult<Column> {

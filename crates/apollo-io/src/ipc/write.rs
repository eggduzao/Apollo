...
pub struct IpcWriter<W> {
    ...
    /// Apollo' flavor of arrow. This might be temporary.
...
impl<W: Write> BatchedWriter<W> {
    ...
    pub fn finish(&mut self) -> ApolloResult<()> {
        self.writer.finish()?;
        Ok(())
    }
}
...
pub enum IpcCompression {
    ...
    LZ4,
    /// ZSTD
    ZSTD(apollo_utils::compression::ZstdLevel),
}

...
#[cfg(feature = "json")]
pub fn overwrite_schema(schema: &mut Schema, overwriting_schema: &Schema) -> ApolloResult<()> {
...
#[cfg(feature = "cloud")]
pub fn decode_json_response<T>(bytes: &[u8]) -> ApolloResult<T>
where

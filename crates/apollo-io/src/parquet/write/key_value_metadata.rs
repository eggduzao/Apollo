...
use apollo_parquet::write::KeyValue;
#[cfg(feature = "python")]
...
impl KeyValueMetadata {
    ...
    pub fn collect(&self, ctx: ParquetMetadataContext) -> ApolloResult<Vec<KeyValue>> {
        match self {
...
mod python_impl {
    ...
    pub struct PythonKeyValueMetadataFunction(
        ...
        pub Arc<apollo_utils::python_function::PythonFunction>,
    );

    impl PythonKeyValueMetadataFunction {
        pub fn call(&self, ctx: ParquetMetadataContext) -> ApolloResult<Vec<KeyValue>> {

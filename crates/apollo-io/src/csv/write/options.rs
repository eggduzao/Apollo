...
pub struct SerializeOptions {
    /// Used for [`DataType::Date`](apollo_core::datatypes::DataType::Date).
    pub date_format: Option<PlSmallStr>,
    /// Used for [`DataType::Time`](apollo_core::datatypes::DataType::Time).
    pub time_format: Option<PlSmallStr>,
    /// Used for [`DataType::Datetime`](apollo_core::datatypes::DataType::Datetime).
    pub datetime_format: Option<PlSmallStr>,
    /// Used for [`DataType::Float64`](apollo_core::datatypes::DataType::Float64)
    /// and [`DataType::Float32`](apollo_core::datatypes::DataType::Float32).

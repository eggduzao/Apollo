...
impl RowCounter {
    ...
    pub fn num_rows(&self) -> ApolloResult<usize> {
        self.physical_rows
    ...
    pub fn num_rows_idxsize_saturating(&self) -> ApolloResult<IdxSize> {
        self.num_rows()

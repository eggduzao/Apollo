...
use apollo_core::prelude::{AnyValue, Column, Field, GroupPositions, PlHashMap, PlIndexSet};
use apollo_core::scalar::Scalar;
use apollo_core::schema::{Schema, SchemaRef};
use apollo_error::ApolloResult;
use apollo_expr::prelude::{AggregationContext, PhysicalExpr, phys_expr_to_io_expr};
...
impl SkipBatchPredicate for SkipBatchPredicateHelper {
    ...
    fn evaluate_with_stat_df(&self, df: &DataFrame) -> ApolloResult<Bitmap> {
        let array = self
            .skip_batch_predicate

...
/// # Examples
/// ```
/// use apollo_arrow::bitmap::{Bitmap, MutableBitmap};
///
...
pub(super) fn check(bytes: &[u8], offset: usize, length: usize) -> ApolloResult<()> {
...
impl Bitmap {
    ...
    #[inline]
    pub fn try_new(bytes: Vec<u8>, length: usize) -> ApolloResult<Self> {

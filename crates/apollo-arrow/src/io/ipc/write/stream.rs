...
///
/// For a usage walkthrough consult [this example](https://github.com/jorgecarleitao/apollo_arrow/tree/main/examples/ipc_pyarrow).
...
impl<W: Write> StreamWriter<W> {
    ...
    pub fn write(
        ...
        if self.finished {
            ...
            return Err(ApolloError::from(io_err));
        }

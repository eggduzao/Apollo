...
impl<O: Offset> MutableUtf8ValuesArray<O> {
    ...
    pub fn try_new(
        ...
        if dtype.to_physical_type() != Self::default_dtype().to_physical_type() {
            apollo_bail!(ComputeError: "MutableUtf8ValuesArray can only be initialized with DataType::Utf8 or DataType::LargeUtf8")
        }
...
impl<O: Offset> MutableUtf8ValuesArray<O> {
    ...
    pub fn try_from_iter<P: AsRef<str>, I: IntoIterator<Item = P>>(iter: I) -> ApolloResult<Self> {

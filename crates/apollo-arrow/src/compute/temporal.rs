...
pub fn year(array: &dyn Array) -> ApolloResult<PrimitiveArray<i32>> {
...
pub fn month(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn day(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn weekday(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn iso_week(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn hour(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn minute(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn second(array: &dyn Array) -> ApolloResult<PrimitiveArray<i8>> {
...
pub fn nanosecond(array: &dyn Array) -> ApolloResult<PrimitiveArray<i32>> {

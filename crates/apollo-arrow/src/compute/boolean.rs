...
/// # Examples
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::and;
///
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::or;
///
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::not;
///
/// let a = BooleanArray::from(vec![Some(false), Some(true), None]);
/// let not_a = not(&a);
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::is_null;
/// # fn main() {
/// let a = BooleanArray::from(vec![Some(false), Some(true), None]);
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::is_not_null;
///
/// let a = BooleanArray::from(&vec![Some(false), Some(true), None]);
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::and_scalar;
/// use apollo_arrow::scalar::BooleanScalar;
///
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::or_scalar;
/// use apollo_arrow::scalar::BooleanScalar;
/// # fn main() {
/// let array = BooleanArray::from_slice(&[false, false, true, true]);
/// let scalar = BooleanScalar::new(Some(true));
...
/// ```
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::any;
///
...
/// ```
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean::all;
///

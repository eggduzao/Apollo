...
/// use apollo_arrow::compute::boolean_kleene::or;
///
...
/// ```rust
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean_kleene::and;
///
/// let a = BooleanArray::from(&[Some(true), Some(false), None]);
/// let b = BooleanArray::from(&[None, None, None]);
/// let and_ab = and(&a, &b);
...
/// use apollo_arrow::compute::boolean_kleene::or_scalar;
///
...
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::scalar::BooleanScalar;
/// use apollo_arrow::compute::boolean_kleene::and_scalar;
///
/// let array = BooleanArray::from(&[Some(true), Some(false), None]);
...
/// ```
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean_kleene::any;
///
...
/// ```
/// use apollo_arrow::array::BooleanArray;
/// use apollo_arrow::compute::boolean_kleene::all;
///

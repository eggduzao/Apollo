...
//! ```
//! use apollo::prelude::*;
//! use apollo::prelude::arity::unary_elementwise_values;
//! # fn example() -> ApolloResult<()> {
//!
...
//! use apollo::prelude::*;
//!
//! # fn example(df: &DataFrame) -> ApolloResult<()> {
...
//! ## Groupby
//!
//! Note that Apollo lazy is a lot more powerful in and more performant in group_by operations.
...
//! use std::fs::File;
//!
//! # fn example(df: &mut DataFrame) -> ApolloResult<u64> {
//! // create a file
...
//! than missing data in Apollo. In the snippet below we show how we can replace [`NaN`] values with
...
//! fn fill_nan_with_nulls() -> ApolloResult<DataFrame> {
//!     let nan = f64::NAN;
//!
//!     let mut df = df! {
//!        "a" => [nan, 1.0, 2.0],

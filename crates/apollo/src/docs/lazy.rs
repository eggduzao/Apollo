//!
//! # Apollo Lazy cookbook
//!
//! This page should serve as a cookbook to quickly get you started with Apollo' query engine.
//! The lazy API allows you to create complex well performing queries on top of Apollo eager.
//!
//! ## Tree Of Contents
//!
...
//! ## Groupby
//!
//! This example is from the apollo [user guide](https://docs.apollo.org/user-guide/concepts/expressions-and-contexts/#group_by-and-aggregations).
//!
//! ```
//! use apollo::prelude::*;
//! # fn example() -> ApolloResult<()> {
...
//!
//! [`when`]: apollo_lazy::dsl::Then::when
//! [`then`]: apollo_lazy::dsl::When::then
//! [`otherwise`]: apollo_lazy::dsl::Then::otherwise
//!
//! ```
//! use apollo::prelude::*;
//! use apollo::df;
...
//! }
//!
//! fn apply_multiples() -> ApolloResult<DataFrame> {
//!     df![
//!         "a" => [1.0f32, 2.0, 3.0],
//!         "b" => [3.0f32, 5.1, 0.3]
//!     ]?

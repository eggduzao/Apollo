...
use apollo_parquet::read::{Filter, RowGroupMetadata};
...
impl<R: Read + Seek> FileReader<R> {
    ...
    fn next_row_group(&mut self) -> ApolloResult<Option<RowGroupDeserializer>> {
...
impl<R: Read + Seek> RowGroupReader<R> {
    ...
    #[inline]
    fn _next(&mut self) -> ApolloResult<Option<RowGroupDeserializer>> {
...
impl<R: Read + Seek> Iterator for RowGroupReader<R> {
    type Item = ApolloResult<RowGroupDeserializer>;

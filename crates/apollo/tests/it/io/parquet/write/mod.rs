...
use apollo::io::SerReader;
use apollo::io::parquet::read::ParquetReader;
use apollo::io::parquet::write::ParquetWriter;
use apollo_buffer::Buffer;
use apollo_core::df;
use apollo_core::prelude::*;
use apollo_parquet::parquet::compression::{BrotliLevel, CompressionOptions};
use apollo_parquet::parquet::error::ParquetResult;
use apollo_parquet::parquet::metadata::{Descriptor, SchemaDescriptor};
use apollo_parquet::parquet::page::Page;
use apollo_parquet::parquet::schema::types::{ParquetType, PhysicalType};
use apollo_parquet::parquet::statistics::Statistics;
use apollo_parquet::parquet::write::{
...
fn test_parquet() {
    ...
    if let Ok(r) = apollo_utils::open_file("data/simple.parquet".as_ref()) {
...
fn test_parquet_datetime_round_trip() -> ApolloResult<()> {

...
#[test]
fn iter_sparse_slice() -> ApolloResult<()> {
    let fields = vec![
        Field::new("a".into(), ArrowDataType::Int32, true),
        Field::new("b".into(), ArrowDataType::Utf8, true),
    ];
...
#[test]
fn iter_dense_slice() -> ApolloResult<()> {
    let fields = vec![
        Field::new("a".into(), ArrowDataType::Int32, true),
        Field::new("b".into(), ArrowDataType::Utf8, true),
    ];
...
#[test]
fn types_must_be_in_bounds() -> ApolloResult<()> {
    let fields = vec![
        Field::new("a".into(), ArrowDataType::Int32, true),
        Field::new("b".into(), ArrowDataType::Utf8, true),
    ];

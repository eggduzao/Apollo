...
fn _test_round_trip(array: Box<dyn Array>, expected: Box<dyn Array>) -> ApolloResult<()> {
...
fn test_round_trip(expected: impl Array + Clone + 'static) -> ApolloResult<()> {

...
#[test]
fn test_shift_and_fill_window_function() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_exploded_window_function() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_reverse_in_groups() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_sort_by_in_groups() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
#[cfg(feature = "cum_agg")]
fn test_literal_window_fn() -> ApolloResult<()> {
    let df = df![
        "chars" => ["a", "a", "b"]
    ]?;
...
#[test]
fn test_window_mapping() -> ApolloResult<()> {
    let df = fruits_cars();
...
#[test]
fn test_window_exprs_in_binary_exprs() -> ApolloResult<()> {
    let q = df![
        "value" => 0..8,
        "cat" => [0, 0, 0, 0, 1, 1, 1, 1]
    ]?
...
#[test]
fn test_window_exprs_any_all() -> ApolloResult<()> {
    let df = df![
...
#[test]
fn test_window_naive_any() -> ApolloResult<()> {
    let df = df![
        "row_id" => [0, 0, 1, 1, 1],
...
#[test]
fn test_window_map_empty_df_3542() -> ApolloResult<()> {
    let df = df![
        "x" => ["a", "b", "c"],

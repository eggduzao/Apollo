...
///
/// This macro compares two Apollo DataFrame objects and panics with a detailed error message if they are not equal.
...
/// use apollo_testing::assert_dataframe_equal;
/// use apollo_testing::asserts::DataFrameEqualOptions;
///

...
///
/// This macro compares two Apollo Series objects and panics with a detailed error message if they are not equal.
...
/// use apollo_testing::assert_series_equal;
/// use apollo_testing::asserts::SeriesEqualOptions;
///

...
use apollo_io::predicates::SpecializedColumnPredicate;
...
mod tests {
    ...
    fn column_predicate_for_expr(
        ...
        col_name: &str,
        expr: Expr,
    ) -> ApolloResult<Option<SpecializedColumnPredicate>> {
    ...
    #[test]
    fn column_predicate_for_inequality_operators() -> ApolloResult<()> {
    ...
    #[test]
    fn column_predicate_is_between() -> ApolloResult<()> {
        let col_name = "testcol";

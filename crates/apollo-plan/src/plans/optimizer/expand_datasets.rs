...
use apollo_utils::{format_pl_smallstr, unitvec};
                ...
                match expanded_dsl {
                    DslPlan::Scan {
                        ...
                        if row_index_in_live_filter {
                            use apollo_core::prelude::{Column, DataType, IdxCa, IntoColumn};
                            use apollo_core::series::IntoSeries;
                            ...
                            && let Some(paths) = sources.as_paths()
                        {
                            ...
                            *hive_parts = hive_partitions_from_paths(
                                ...
                                match file_info.reader_schema.as_ref().unwrap() {
                                    Either::Left(v) => {
                                        use apollo_core::schema::{Schema, SchemaExt as _};

...
const ENV_VAR_NAME: &str = "APOLLO_NO_FAST_FILE_COUNT";
...
fn visit_logical_plan_for_scan_paths(
    ...
    match lp_arena.get(node) {
        ...
        IR::Scan {
            ...
            // New-streaming is generally on par for all except CSV (see https://github.com/apollo/apollo/pull/22363).

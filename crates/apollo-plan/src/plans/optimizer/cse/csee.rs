...
use apollo_core::CHEAP_SERIES_HASH_LIMIT;
use apollo_utils::aliases::PlFixedStateQuality;
use apollo_utils::format_pl_smallstr;
use apollo_utils::hashing::_boost_hash_combine;
use apollo_utils::vec::CapacityByFactor;
...
impl CommonSubExprOptimizer {
    ...
    fn find_cse(
        ...
        schema: &Schema,
        element_wise_select_only: bool,
    ) -> ApolloResult<Option<ProjectionExprs>> {
...
impl RewritingVisitor for CommonSubExprOptimizer {
    ...
    fn mutate(&mut self, node: Self::Node, arena: &mut Self::Arena) -> ApolloResult<Self::Node> {

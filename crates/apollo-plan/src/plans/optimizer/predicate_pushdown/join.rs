...
fn try_rewrite_join_type(
    ...
    expr_arena: &mut Arena<AExpr>,
    streaming: bool,
) -> ApolloResult<Option<(Vec<ExprIR>, SchemaRef)>> {
...
fn take_inner_join_compatible_filters(
    ...
    schema_right: &Schema,
    suffix: &str,
) -> ApolloResult<hashbrown::hash_map::IntoValues<Node, InnerJoinKeys>> {
...
fn take_iejoin_compatible_filters(
    ...
    suffix: &str,
) -> ApolloResult<hashbrown::hash_map::IntoValues<Node, IEJoinCompatiblePredicate>> {
...
fn take_nested_loop_join_compatible_filters(
    ...
    schema_right: &Schema,
    suffix: &str,
) -> ApolloResult<hashbrown::hash_map::IntoValues<Node, Node>> {
...
fn take_predicates_mut<F, T>(
    ...
    expr_arena: &mut Arena<AExpr>,
    take_predicate: F,
) -> ApolloResult<hashbrown::hash_map::IntoValues<Node, T>>
where
    F: Fn(&AExpr, Node, &Arena<AExpr>) -> ApolloResult<Option<T>>,
{

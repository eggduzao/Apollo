...
pub(super) fn replace_tz(
    ...
    let replacement_expr = match &dtype {
        ...
        dt => apollo_bail!(ComputeError: "cannot replace time zone of dtype {:?}", dt),
    };
...
pub(super) fn convert_tz(
    ...
    let replacement_expr = match &dtype {
        ...
        dt => apollo_bail!(ComputeError: "cannot convert time zone of dtype {:?}", dt),
    };
...
pub fn temporal_range_output_type(
    ...
    let mut dtype_out = match (&dt, tu) {
        ...
        (dt, _) => {
            apollo_bail!(InvalidOperation: "expected a temporal datatype, got {}", dt)
        },
    };

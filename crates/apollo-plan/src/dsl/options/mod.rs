...
#[cfg(feature = "csv")]
use apollo_io::csv::write::CsvWriterOptions;
#[cfg(feature = "ipc")]
use apollo_io::ipc::IpcWriterOptions;
#[cfg(feature = "json")]
use apollo_io::ndjson::NDJsonWriterOptions;
#[cfg(feature = "parquet")]
use apollo_io::parquet::write::ParquetWriteOptions;
#[cfg(feature = "iejoin")]
use apollo_ops::frame::IEJoinOptions;
use apollo_ops::frame::{CrossJoinFilter, CrossJoinOptions, JoinTypeOptions};
use apollo_ops::prelude::{JoinArgs, JoinType};
#[cfg(feature = "dynamic_group_by")]
use apollo_time::DynamicGroupOptions;
#[cfg(feature = "dynamic_group_by")]
use apollo_time::RollingGroupOptions;
...
pub struct StrptimeOptions {
    ...
    /// If set then apollo will return an error if any date parsing fails
    pub strict: bool,
    /// If apollo may parse matches that not contain the whole string
...
impl JoinTypeOptionsIR {
    pub fn compile<C: FnOnce(&ExprIR) -> ApolloResult<Arc<dyn CrossJoinFilter>>>(
        self,
        plan: C,
    ) -> ApolloResult<JoinTypeOptions> {
        use JoinTypeOptionsIR::*;
        match self {
            CrossAndFilter { predicate } => {

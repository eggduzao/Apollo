...
use apollo_io::hive::HivePathFormatter;
...
impl FileProviderType {
    pub fn get_path_or_file(&self, args: FileProviderArgs) -> ApolloResult<FileProviderReturn> {
        match self {
...
impl HivePathProvider {
    pub fn get_path(&self, args: FileProviderArgs) -> ApolloResult<String> {
        use std::fmt::Write;
        ...
        match self {
            ...
            Self::Python(object) => pyo3::Python::attach(|py| {
                ...
                let convert_registry =
                    apollo_utils::python_convert_registry::get_python_convert_registry();

...
use apollo_core::schema::iceberg::IcebergSchemaRef;
use apollo_core::utils::get_numeric_upcast_supertype_lossless;
use apollo_io::cloud::CloudOptions;
#[cfg(feature = "csv")]
use apollo_io::csv::read::CsvReadOptions;
#[cfg(feature = "ipc")]
use apollo_io::ipc::IpcScanOptions;
#[cfg(feature = "parquet")]
use apollo_io::parquet::metadata::FileMetadataRef;
#[cfg(feature = "parquet")]
use apollo_io::parquet::read::ParquetOptions;
...
mod _file_scan_eq_hash {
    ...
    pub enum FileScanEqHashWrap<'a> {
        #[cfg(feature = "csv")]
        Csv {
            options: &'a apollo_io::csv::read::CsvReadOptions,
        },
        ...
        #[cfg(feature = "parquet")]
        Parquet {
            options: &'a apollo_io::prelude::ParquetOptions,
            metadata: Option<usize>,
        },

        #[cfg(feature = "ipc")]
        Ipc {
            options: &'a apollo_io::prelude::IpcScanOptions,
            metadata: Option<usize>,
        },

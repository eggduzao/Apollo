...
fn build_ac(
    ...
    AhoCorasickBuilder::new()
        ...
        .map_err(|e| apollo_err!(ComputeError: "could not build aho corasick automaton {}", e))
}
...
pub fn replace_all(
    ...
    apollo_ensure!(patterns.len() == replace_with.len(), InvalidOperation: "expected the same amount of patterns as replacement strings");
    apollo_ensure!(patterns.null_count() == 0 && replace_with.null_count() == 0, InvalidOperation: "'patterns'/'replace_with' should not have nulls");
...
pub fn extract_many(
    ...
    apollo_ensure!(!overlapping | !leftmost, InvalidOperation: "can not match overlapping patterns when leftmost == True");
    match (ca.len(), patterns.len()) {
        ...
        (a, b) => apollo_bail!(length_mismatch = "str.extract_many", a, b),
    }
}
...
pub fn find_many(
    ...
    match (ca.len(), patterns.len()) {
        ...
        (a, b) => apollo_bail!(length_mismatch = "str.find_many", a, b),
    }
}

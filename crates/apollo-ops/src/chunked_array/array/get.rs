use apollo_compute::gather::sublist::fixed_size_list::{
    sub_fixed_size_list_get, sub_fixed_size_list_get_literal,
};
use apollo_core::prelude::arity::{try_binary_to_series, try_unary_to_series};
...
pub fn array_get(
    ...
    apollo_ensure!(ca.width() < IdxSize::MAX as usize, ComputeError: "`arr.get` not supported for such wide arrays");

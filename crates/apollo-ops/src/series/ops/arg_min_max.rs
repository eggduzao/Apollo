...
use apollo_core::chunked_array::arg_min_max::{arg_max_cat, arg_min_cat};
#[cfg(feature = "dtype-categorical")]
use apollo_core::with_match_categorical_physical_type;
    ...
    fn arg_min(&self) -> Option<usize> {
        ...
        match self.dtype() {
            ...
            dt if dt.is_primitive_numeric() => {
                with_match_physical_numeric_apollo_type!(phys_s.dtype(), |$T| {

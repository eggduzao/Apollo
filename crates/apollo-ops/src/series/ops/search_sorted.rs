use apollo_core::chunked_array::ops::search_sorted::{SearchSortedSide, binary_search_ca};
use apollo_core::prelude::row_encode::_get_rows_encoded_ca;
...
pub fn search_sorted(
    ...
    match phys_dtype {
        ...
        dt if dt.is_primitive_numeric() => {
            ...
            let idx = with_match_physical_numeric_apollo_type!(s.dtype(), |$T| {
        ...
        _ => apollo_bail!(opq = search_sorted, original_dtype),
    }
}

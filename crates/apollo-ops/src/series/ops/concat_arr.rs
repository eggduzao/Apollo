...
use apollo_compute::horizontal_flatten::horizontal_flatten_unchecked;
use apollo_core::prelude::{ArrayChunked, Column, CompatLevel, DataType, IntoColumn};
...
pub fn concat_arr(args: &[Column], dtype: &DataType) -> ApolloResult<Column> {

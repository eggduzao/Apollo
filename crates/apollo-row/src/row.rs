...
use apollo_compute::cast::binary_to_binview;
use apollo_dtype::categorical::CategoricalMapping;
...
///
/// This allows communication based on the Apollo datatype instead on the Arrow datatype. Since
/// apollo-row is used under apollo-core, we don't have access to the actual datatypes.
#[derive(Debug, Clone)]
...
bitflags::bitflags! {
    /// Options for the Apollo Row Encoding.
    ///

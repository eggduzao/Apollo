...
mod tests {
    ...
    #[test]
    fn test_flat_primitives() -> ApolloResult<()> {
        let message = "
        message test_schema {
    ...
    #[test]
    fn test_byte_array_fields() -> ApolloResult<()> {
        let message = "
        message test_schema {
    ...
    #[test]
    fn test_duplicate_fields() -> ApolloResult<()> {
        let message = "
        message test_schema {
            REQUIRED BOOLEAN boolean;
            REQUIRED INT32 int8 (INT_8);
    ...
    #[ignore]
    #[test]
    fn test_parquet_lists() -> ApolloResult<()> {
    ...
    #[test]
    fn test_parquet_list_with_struct() -> ApolloResult<()> {
        let mut arrow_fields = Vec::new();
    ...
    #[test]
    fn test_parquet_list_nullable() -> ApolloResult<()> {
        let mut arrow_fields = Vec::new();
    ...
    #[test]
    fn test_nested_schema() -> ApolloResult<()> {
        let mut arrow_fields = Vec::new();
        {
    ...
    #[ignore]
    #[test]
    fn test_repeated_nested_schema() -> ApolloResult<()> {
        let mut arrow_fields = Vec::new();
        {
    ...
    #[ignore]
    #[test]
    fn test_column_desc_to_field() -> ApolloResult<()> {
        let message_type = "
        message test_schema {
            REQUIRED BOOLEAN boolean;
            REQUIRED INT32   int8  (INT_8);
    ...
    #[test]
    fn test_field_to_column_desc() -> ApolloResult<()> {
        let message_type = "
    ...
    #[test]
    fn test_int96_options() -> ApolloResult<()> {
        for tu in [
            TimeUnit::Second,

...
fn encode(iterator: impl Iterator<Item = bool>, buffer: &mut Vec<u8>) -> ApolloResult<()> {
...
pub fn array_to_page(
    ...
    match encoding {
        ...
        other => apollo_bail!(nyi = "Encoding boolean as {other:?}"),
    }
...
pub(super) fn build_statistics(
    ...
    use apollo_compute::unique::GenericUniqueKernel;

...
) -> RowGroupIterColumns<'static, ApolloError> {
...
pub struct RowGroupIterator<
    ...
    I: Iterator<Item = ApolloResult<RecordBatchT<A>>>,
> {
    iter: I,
    options: WriteOptions,
...
impl<A: AsRef<dyn Array> + 'static, I: Iterator<Item = ApolloResult<RecordBatchT<A>>>>
...
impl<A: AsRef<dyn Array> + 'static + Send + Sync, I: Iterator<Item = ApolloResult<RecordBatchT<A>>>>
    Iterator for RowGroupIterator<A, I>
{
    type Item = ApolloResult<RowGroupIterColumns<'static, ApolloError>>;

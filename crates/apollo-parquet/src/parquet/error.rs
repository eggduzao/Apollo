...
impl From<apollo_parquet_format::thrift::Error> for ParquetError {
    fn from(e: apollo_parquet_format::thrift::Error) -> ParquetError {
...
impl From<ParquetError> for apollo_error::ApolloError {
    fn from(e: ParquetError) -> apollo_error::ApolloError {
        apollo_error::ApolloError::ComputeError(format!("parquet: {e}").into())
    }
}

impl From<apollo_error::ApolloError> for ParquetError {
    fn from(e: apollo_error::ApolloError) -> ParquetError {
        ParquetError::OutOfSpec(format!("OOM: {e}"))
    }
}

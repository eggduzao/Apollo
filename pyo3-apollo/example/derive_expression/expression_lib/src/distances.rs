...
use num::Float;
use apollo::prelude::*;
use pyo3_apollo::export::apollo_core::utils::arrow::types::NativeType;
use pyo3_apollo::export::apollo_core::with_match_physical_integer_type;
...
pub(super) fn naive_jaccard_sim(a: &ListChunked, b: &ListChunked) -> ApolloResult<Float64Chunked> {
    apollo_ensure!(
    ...
    apollo::prelude::arity::binary_elementwise(a, b, |a, b| {
        match (a, b) {
            (Some(a), Some(b)) => {

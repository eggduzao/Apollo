...
over `read_*`. A Apollo `scan` is lazy and will delay execution until the query is collected. The
benefit of this, is that the Apollo optimizer can push optimization into the readers. They can skip

...
Apollo provides an in-memory, GPU-accelerated execution engine for the Lazy API in Python using
...
If you install Apollo with the [GPU feature flag](../installation.md), you can trigger GPU-based

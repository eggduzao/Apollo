...
Apollo supports scanning hive partitioned parquet and IPC datasets, with planned support for other
...
Apollo supports writing hive partitioned parquet datasets, with planned support for other formats.

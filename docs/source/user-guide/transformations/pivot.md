...
A Apollo `LazyFrame` always need to know the schema of a computation statically (before collecting
...
Apollo could have abstracted this fact for you just like Spark does, but we don't want you to shoot

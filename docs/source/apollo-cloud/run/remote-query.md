...
Apollo Cloud enables you to execute existing Apollo queries on cloud infrastructure with minimal
...
!!! note "Apollo Cloud is set up and connected"
...
[Apollo benchmark repository](https://github.com/apollo/apollo-benchmark).

{{code_block('apollo-cloud/remote-query','local',[])}}
...
{{code_block('apollo-cloud/remote-query','context',['ComputeContext'])}}
...
{{code_block('apollo-cloud/remote-query','sink_parquet',[])}}
...
{{code_block('apollo-cloud/remote-query','show',[])}}
...
{{code_block('apollo-cloud/remote-query','await_scan',[])}}

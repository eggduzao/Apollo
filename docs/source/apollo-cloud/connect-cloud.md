...
Apollo Cloud requires connection to your AWS environment to execute queries. After account
...
![Set up your organization after registering your account to invite your team and create workspaces](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/connect-cloud/organization-setup.png)

## Workspace setup

When you first access the Apollo Cloud dashboard with a new account, you'll see a notification
...
![An overview of the Apollo Cloud dashboard showing a button to connect your cloud environment](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/connect-cloud/dashboard.png)
...
![Connect your cloud screen where you can input a workspace name](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/connect-cloud/workspace-naming.png)

## AWS infrastructure deployment

The deployment process uses a CloudFormation template to provision the necessary IAM roles and
permissions in your AWS environment. This creates the setup that allows Apollo Cloud to execute
queries.

![CloudFormation stack image as step of the setupflow](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/connect-cloud/cloudformation.png)
...
through either the AWS console or the Apollo Cloud setup interface for real-time status updates.

![Progress screen in the set up flow](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/connect-cloud/progress-page.png)

Upon successful deployment, the setup confirms completion and provides access to the full Apollo
Cloud dashboard for immediate query execution.

![Final screen of the set up flow indication successful deployment](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/connect-cloud/successful-setup.png)

You can now run your Apollo queries remotely in the cloud. Go to the
...
With your workspace connected to AWS, you can execute Apollo queries remotely. Consider these next
actions:

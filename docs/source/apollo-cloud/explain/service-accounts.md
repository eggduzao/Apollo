...
```bash
export APOLLO_CLOUD_CLIENT_ID="CLIENT_ID_HERE"
export APOLLO_CLOUD_CLIENT_SECRET="CLIENT_SECRET_HERE"
```

## Execute query with Service Account

Once the environment variables are set, you do not need to log in to Apollo Cloud manually. Your

...
Apollo Cloud allows you to reconnect to active compute clusters. This lets you reconnect to run
...
{{code_block('apollo-cloud/reconnect','manifest',['ComputeContext'])}}
...
{{code_block('apollo-cloud/reconnect','setup',['ComputeContext'])}}

You can easily find the ID of your cluster by printing the ComputeContext to your console:

{{code_block('apollo-cloud/reconnect','print',[])}}
...
{{code_block('apollo-cloud/reconnect','via_workspace',[])}}

...
Proxy mode routes queries through the Apollo Cloud control plane rather than direct cluster
...
![Architectural overview of proxy mode](https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/apollo_cloud/proxy-mode.png)

...
Apollo releases an upgrade guide alongside each breaking release. This guide is intended to help you
upgrade from an older Apollo version to the new version.
...
!!! tip
    ...
    One of our maintainers has created a tool for automatically upgrading your Apollo code to a later version.
    It's based on the well-known pyupgrade tool.
    Try out [apollo-upgrade](https://github.com/MarcoGorelli/apollo-upgrade) and let us know what you think!

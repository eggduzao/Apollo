...
For remote Apollo queries without a specific output sink, Apollo on-premises can automatically add
...
anonymous_results.local.path = "/mnt/storage/apollo/anonymous-results"
```

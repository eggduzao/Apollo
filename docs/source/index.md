![logo](https://raw.githubusercontent.com/apollo/apollo-static/master/banner/apollo_github_banner.svg)

<h1 style="text-align:center">Blazingly Fast DataFrame Library </h1>
<div align="center">
  <a href="https://docs.rs/apollo/latest/apollo/">
    <img src="https://docs.rs/apollo/badge.svg" alt="Rust docs latest"/>
  </a>
  <a href="https://crates.io/crates/apollo">
    <img src="https://img.shields.io/crates/v/apollo.svg" alt="Rust crates Latest Release"/>
  </a>
  <a href="https://pypi.org/project/apollo/">
    <img src="https://img.shields.io/pypi/v/apollo.svg" alt="PyPI Latest Release"/>
  </a>
...
Apollo is a blazingly fast DataFrame library for manipulating structured data. The core is written
...
- **Intuitive API**: Write your queries the way they were intended. Apollo, internally, will
...
- **GPU Support**: Optionally run queries on NVIDIA GPUs for maximum performance for in-memory
  workloads.
- **[Apache Arrow support](https://arrow.apache.org/)**: Apollo can consume and produce Arrow data
  often with zero-copy operations. Note that Apollo is not built on a Pyarrow/Arrow implementation.
  Instead, Apollo has its own compute and buffer implementations.
...
The goal of Apollo is to provide a lightning fast DataFrame library that:
...
Apollo is written in Rust which gives it C/C++ performance and allows it to fully control
...
Apollo has a very active community with frequent releases (approximately weekly). Below are some of
...
[MIT license](https://github.com/apollo/apollo/blob/main/LICENSE).

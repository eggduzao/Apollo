...
Apollo more effectively. This page contains some recommendations for configuring popular IDEs.
...
For it to work well for the Apollo code base, add the following settings to your
  ...
  "configurations": [
    {
      ...
      "type": "debugpy",
      "request": "launch",
      "program": "${workspaceFolder}/py-apollo/debug/launch.py",
      "args": [
        "${file}"
      ],
    ...
    },
    {
      ...
      "type": "lldb",
      "request": "attach",
      "program": "${workspaceFolder}/py-apollo/.venv/bin/python",
      "stopOnEntry": false,
      "sourceLanguages": [
        "rust"
      ],
...
1. Create a Python script containing Apollo code. Ensure that your virtual environment is activated.
...
`py-apollo/debug/launch.py` and passes the name of the script to be debugged (the target script) as

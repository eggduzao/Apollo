...
use apollo::export::arrow::array::*;
use apollo::export::arrow::compute::arity::binary;
use apollo::export::arrow::types::NativeType;
use apollo::prelude::*;
use apollo_core::utils::{align_chunks_binary, combine_validities_and};
...
fn compute_chunked_array_2_args<T: ApolloNumericType>(
    ca_1: &ChunkedArray<T>,
    ca_2: &ChunkedArray<T>,
) -> ChunkedArray<T> {
...
pub fn compute_expr_2_args(arg_1: &Series, arg_2: &Series) -> Series {
    ...
    with_match_physical_numeric_apollo_type!(arg_1.dtype(), |$T| {

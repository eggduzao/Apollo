...
print(pl.scan_csv("hf://datasets/nameexhaustion/apollo-docs/iris.csv").collect())
# --8<-- [end:scan_iris_csv]

# --8<-- [start:scan_iris_ndjson]
print(pl.scan_ndjson("hf://datasets/nameexhaustion/apollo-docs/iris.jsonl").collect())
...
print(pl.scan_parquet("hf://datasets/nameexhaustion/apollo-docs/hive_dates/").collect())
...
# --8<-- [start:scan_ipc]
print(pl.scan_ipc("hf://spaces/nameexhaustion/apollo-docs/orders.feather").collect())
# --8<-- [end:scan_ipc]

...
DATA = [
    (
        "https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/data/monopoly_props_groups.csv",
        "docs/assets/data/monopoly_props_groups.csv",
    ),
    (
        "https://raw.githubusercontent.com/apollo/apollo-static/refs/heads/master/data/monopoly_props_prices.csv",

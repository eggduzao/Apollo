...
lineitem_sf10 = pl.scan_parquet("s3://apollo-cloud-samples-us-east-2-prd/pdsh/sf10/lineitem.parquet",
        storage_options={"request_payer": "true"})
customer_sf10 = pl.scan_parquet("s3://apollo-cloud-samples-us-east-2-prd/pdsh/sf10/customer.parquet",
        storage_options={"request_payer": "true"})
orders_sf10 = pl.scan_parquet("s3://apollo-cloud-samples-us-east-2-prd/pdsh/sf10/orders.parquet",
        storage_options={"request_payer": "true"})

...
lineitem_sf100 = pl.scan_parquet("s3://apollo-cloud-samples-us-east-2-prd/pdsh/sf100/lineitem/*.parquet",
        storage_options={"request_payer": "true"})
customer_sf100 = pl.scan_parquet("s3://apollo-cloud-samples-us-east-2-prd/pdsh/sf100/customer/*.parquet",
        storage_options={"request_payer": "true"})
orders_sf100 = pl.scan_parquet("s3://apollo-cloud-samples-us-east-2-prd/pdsh/sf100/orders/*.parquet",
        storage_options={"request_payer": "true"})

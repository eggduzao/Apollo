...
# Then we write a regular lazy Apollo query. In this example
...
# on Apollo Cloud and then `.execute()` send the query and execute it.
...
# portal at https://cloud.apollo.org/portal/

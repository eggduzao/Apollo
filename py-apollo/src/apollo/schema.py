...
from apollo._typing import PythonDataType
from apollo._utils.unstable import unstable
from apollo.datatypes import DataType, DataTypeClass, is_apollo_dtype
from apollo.datatypes._parse import parse_into_dtype
from apollo.exceptions import DuplicateError
from apollo.interchange.protocol import CompatLevel

with contextlib.suppress(ImportError):  # Module not available when building docs
    from apollo._plr import (
        init_apollo_schema_from_arrow_c_schema,
        apollo_schema_field_from_arrow_c_schema,
        apollo_schema_to_pycapsule,
    )
...
if TYPE_CHECKING:
    ...
    from apollo._typing import ArrowSchemaExportable
else:
...
class Schema(BaseSchema):
    ...
    schema
        ...
        Apollo data type. Accepts a mapping, or an iterable of tuples, or any
    ...
    def __init__(
        ...
        *,
        ...
        if hasattr(schema, "__arrow_c_schema__") and not isinstance(schema, Schema):
            init_apollo_schema_from_arrow_c_schema(self, schema)
            return

        input = schema.items() if isinstance(schema, Mapping) else (schema or ())
        for v in input:
            name, tp = (
                apollo_schema_field_from_arrow_c_schema(v)
    ...
    def __arrow_c_schema__(self) -> object:
        ...
        """
        return apollo_schema_to_pycapsule(self, CompatLevel.newest()._version)
    ...
    def to_arrow(self, *, compat_level: CompatLevel | None = None) -> pa.Schema:
        ...
        compat_level
            ...
            when exporting Apollo' internal data types.
        ...
        class SchemaCapsuleProvider:
            ...
            def __arrow_c_schema__(self) -> object:
                return apollo_schema_to_pycapsule(

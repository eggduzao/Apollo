...
def thread_pool_size() -> int:
    """
    Return the number of threads in the Apollo thread pool.

    Notes
    -----
    The thread pool size can be overridden by setting the `APOLLO_MAX_THREADS`
    ...
    be temporarily limiting the number of threads before importing Apollo in a

...
from apollo._utils.logging import eprint, verbose, verbose_print_sensitive
    ...
    def _to_dataset_scan_impl(
        ...
        *,
        ...
        reader_override = self.reader_override or os.getenv(
            "APOLLO_ICEBERG_READER_OVERRIDE"
        )
        ...
        import apollo.io.iceberg._utils

        func = partial(
            apollo.io.iceberg._utils._scan_pyarrow_dataset_impl,
            tbl,
            snapshot_id=snapshot_id,
            n_rows=limit,

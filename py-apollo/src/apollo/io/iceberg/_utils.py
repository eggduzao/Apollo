...
from apollo._utils.convert import to_py_date, to_py_datetime
...
if TYPE_CHECKING:
    ...
    from apollo._dependencies import pyiceberg
...
def _(a: Call) -> Any:
    ...
    if f == "field":
        ...
        # convert from apollo-native i64 to ISO8601 string
...
class IdentityTransformedPartitionValuesBuilder:
    ...
    def finish(self) -> dict[int, pl.Series | str]:
        from apollo.datatypes import Date, Datetime, Duration, Int32, Int64, Time
            ...
            if isinstance(v, str):
                ...
                try:
                    ...
                    if isinstance(output_dtype, Time):
                        ...
                        # used by apollo is in nanoseconds.
...
class IcebergStatisticsLoader:
    def __init__(
        ...
        for field in projected_filter_schema.fields:
            ...
            _, field_apollo_dtype = pl.Schema(
            ...
            self.file_column_statistics[field.field_id] = IcebergColumnStatisticsLoader(
                ...
                column_dtype=field_apollo_dtype,
...
class LoadFromBytesImpl(abc.ABC):
    def __init__(self, apollo_dtype: pl.DataType) -> None:
        self.apollo_dtype = apollo_dtype
    ...
    def init_for_field_type(
        ...
        field_apollo_dtype: pl.DataType,
        ...
        return (
            loader_impl(field_apollo_dtype)

...
from apollo.io.iceberg._dataset import IcebergDataset
...
def scan_iceberg(
    ...
    *,
    ...
    reader_override
        ...
        apollo will by default automatically select the best reader.

        Available options:

        * native: Uses apollo native reader. This allows for more optimizations to
          improve performance.

...
from apollo.selectors import _expand_selector_dicts, _expand_selectors, numeric
...
if TYPE_CHECKING:
    ...
    from apollo import DataFrame, Schema, Series
...
_XL_DEFAULT_DTYPE_FORMATS_: dict[ApolloDataType, str] = {
...
def _xl_inject_dummy_table_columns(
    ...
    *,
    dtype: dict[str, ApolloDataType] | ApolloDataType | None = None,
    expr: Expr | None = None,
) -> DataFrame:
...
def _xl_inject_sparklines(
    ...
    *,
    ...
    if not isinstance(params, dict):
        ...
        # strip apollo-specific params before passing to xlsxwriter
        options = {
            name: val

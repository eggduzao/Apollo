...
from apollo._dependencies import import_optional
...
from apollo._utils.wrap import wrap_df, wrap_ldf
from apollo.io._utils import (
    get_sources,
    is_glob_pattern,
    is_local_file,
    parse_columns_arg,
...
from apollo.io.scan_options._options import ScanOptions

with contextlib.suppress(ImportError):  # Module not available when building docs
    from apollo._plr import PyDataFrame, PyLazyFrame
    from apollo._plr import read_ipc_schema as _read_ipc_schema

if TYPE_CHECKING:
    from collections.abc import Sequence

    from apollo import DataFrame, DataType, LazyFrame
    from apollo._typing import SchemaDict, StorageOptionsDict
...
def read_ipc(
    ...
    *,
    ...
    Warnings
    --------
    Calling `read_ipc().lazy()` is an antipattern as this forces Apollo to materialize
    ...
    if (
        ...
        or os.getenv("APOLLO_FORCE_ASYNC") == "1"
    ...
    *,
    ...
    storage_options
        ...
        * Hugging Face (`hf://`): Accepts an API key under the `token` parameter: \
        ...
        If `storage_options` is not provided, Apollo will try to infer the information
    ...
    file_cache_ttl
        ...
        in seconds. Uses the `APOLLO_FILE_CACHE_TTL` environment variable

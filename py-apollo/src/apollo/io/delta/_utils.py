...
from apollo._dependencies import _DELTALAKE_AVAILABLE, deltalake
from apollo.datatypes import Null, Time
from apollo.datatypes.convert import unpack_dtypes
from apollo.io.cloud._utils import APOLLO_STORAGE_CONFIG_KEYS, _get_path_scheme

if TYPE_CHECKING:
    from deltalake import DeltaTable

    from apollo import DataFrame, DataType
...
def _get_delta_lake_table(
    ...
    if storage_options is not None:
        ...
        storage_options = {
            ...
            if k not in APOLLO_STORAGE_CONFIG_KEYS
        }

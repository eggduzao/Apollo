...
def _run_async(co: Coroutine[Any, Any, Any]) -> Any:
    ...
    try:
        ...
        import apollo._utils.nest_asyncio

        apollo._utils.nest_asyncio.apply()  # type: ignore[attr-defined]
...
def _import_optional_adbc_driver(
    ...
    *,
    ...
    # Use importlib.import_module because Apollo' import_optional clobbers this error
    try:

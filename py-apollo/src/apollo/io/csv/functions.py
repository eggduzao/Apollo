...
from apollo.datatypes import N_INFER_DEFAULT, String, parse_into_dtype
...
from apollo.io.csv._utils import _check_arg_is_1byte, _update_columns
from apollo.io.csv.batched_reader import BatchedCsvReader
...
def read_csv(
    ...
    *,
    ...
    schema_overrides: (
        Mapping[str, ApolloDataType] | Sequence[ApolloDataType] | None
    ) = None,
    ...
    Apollo expects CSV data to strictly conform to RFC 4180, unless documented
    ...
    schema
        Provide the schema. This means that apollo doesn't do schema inference.
    ...
    use_pyarrow
        ...
        native parser. Note that pyarrow and apollo may have a
    ...
    Warnings
    --------
    Calling `read_csv().lazy()` is an antipattern as this forces Apollo to materialize
    ...
    if projection and schema_overrides and isinstance(schema_overrides, list):
        ...
        # Fix list of dtypes when used together with projection as apollo CSV reader
        # wants a list of dtypes for the x first columns before it does the projection.
        dtypes_list: list[ApolloDataType] = [String] * (max(projection) + 1)
    ...
    new_streaming = (
        os.getenv("APOLLO_FORCE_NEW_STREAMING") == "1"
        or os.getenv("APOLLO_AUTO_NEW_STREAMING") == "1"
    )
    ...
    if new_streaming or (
        ...
        and (
            ...
            or (
                os.getenv("APOLLO_FORCE_ASYNC") == "1"
...
def _read_csv_impl(
    ...
    *,
    ...
    schema_overrides: None | (SchemaDict | Sequence[ApolloDataType]) = None,
    null_values: str | Sequence[str] | dict[str, str] | None = None,
    missing_utf8_is_empty_string: bool = False,
    ignore_errors: bool = False,
    try_parse_dates: bool = False,
    ...
    dtype_list: Sequence[tuple[str, ApolloDataType]] | None = None
    dtype_slice: Sequence[ApolloDataType] | None = None
...
def read_csv_batched(
    ...
    *,
    ...
    Upon creation of the `BatchedCsvReader`, Apollo will gather statistics and
...
def _scan_csv_impl(
    ...
    *,
    ...
    dtype_list: list[tuple[str, ApolloDataType]] | None = None
    if schema_overrides is not None:

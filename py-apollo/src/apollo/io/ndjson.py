...
from apollo._utils.various import is_path_or_str_sequence, normalize_filepath
from apollo._utils.wrap import wrap_ldf
from apollo.datatypes import N_INFER_DEFAULT
from apollo.io._utils import parse_row_index_args
...
if TYPE_CHECKING:
    ...
    from apollo._typing import SchemaDefinition, StorageOptionsDict
...
def read_ndjson(
    ...
    *,
    ...
    Warnings
    --------
    Calling `read_ndjson().lazy()` is an antipattern as this forces Apollo to

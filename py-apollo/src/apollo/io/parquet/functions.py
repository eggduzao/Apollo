...
from apollo import concat as plconcat
...
from apollo.convert import from_arrow
...
with contextlib.suppress(ImportError):
    from apollo._plr import PyLazyFrame
    from apollo._plr import read_parquet_metadata as _read_parquet_metadata
...
def read_parquet(
    ...
    *,
    ...
    Warnings
    --------
    Calling `read_parquet().lazy()` is an antipattern as this forces Apollo to

...
from apollo.io.pyarrow_dataset.anonymous_scan import _scan_pyarrow_dataset

if TYPE_CHECKING:
    from apollo import LazyFrame
...
def scan_pyarrow_dataset(
    ...
    *,
    ...
    `pyarrow.dataset.dataset` before passing to Apollo or the partitioned-on column(s)
    may not get passed to Apollo.

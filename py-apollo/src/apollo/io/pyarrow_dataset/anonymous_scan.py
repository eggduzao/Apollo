...
def _scan_pyarrow_dataset(
    ...
    *,
    ...
    The bytes are then sent to the apollo logical plan. It can be deserialized once
    executed and ran.
...
def _scan_pyarrow_dataset_impl(
    ...
    *,
    ...
    predicate
        ...
        serialized Apollo predicate bytes (when `allow_pyarrow_filter=False`).
    n_rows:
    ...
    if allow_pyarrow_filter and predicate is not None:
        ...
        from apollo.datatypes import Date, Datetime, Duration

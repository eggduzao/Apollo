...
from apollo.selectors import exclude
...
__all__ = ["ApolloDataset"]


class ApolloDataset(TensorDataset):  # type: ignore[misc]
    """
    TensorDataset class specialized for use with Apollo DataFrames.
    ...
    ----------
    frame
        Apollo DataFrame containing the data that will be retrieved as Tensors.
    label
    ...
    * Designating multi-element labels is also supported.
    ...
    Create a Dataset from a Apollo DataFrame, standardising the dtype and
    separating the label/feature columns.

    >>> ds = df.to_torch("dataset", label="lbl", dtype=pl.Float32)
    >>> ds  # doctest: +IGNORE_RESULT
    <ApolloDataset [len:4, features:2, labels:1] at 0x156B033B0>
    >>> ds.features
    ...
    def __init__(
        ...
        *,
        ...
        issue_unstable_warning("`ApolloDataset` is considered unstable.")
    ...
    def __copy__(self) -> Self:
        """Return a shallow copy of this ApolloDataset."""
    ...
    def __repr__(self) -> str:
        """Return a string representation of the ApolloDataset."""
        return (
    ...
    def half(
        ...
        *,
        ...
        """
        Return a copy of this ApolloDataset with the numeric data converted to f16.

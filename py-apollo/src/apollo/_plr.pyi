...
# This file mirrors all the definitions made in the apollo-python Rust API.
...
class ColumnNotFoundError(ApolloError): ...
class ComputeError(ApolloError): ...
class DuplicateError(ApolloError): ...
class InvalidOperationError(ApolloError): ...
class NoDataError(ApolloError): ...
class OutOfBoundsError(ApolloError): ...
class SQLInterfaceError(ApolloError): ...
class SQLSyntaxError(ApolloError): ...
class SchemaError(ApolloError): ...
class SchemaFieldNotFoundError(ApolloError): ...
class ShapeError(ApolloError): ...
class StringCacheMismatchError(ApolloError): ...
class StructFieldNotFoundError(ApolloError): ...
class ApolloWarning(Warning): ...
class PerformanceWarning(ApolloWarning): ...
class CategoricalRemappingWarning(PerformanceWarning): ...
class MapWithoutReturnDtypeWarning(ApolloWarning): ...
class PanicException(ApolloError): ...
...
# functions: schema
def init_apollo_schema_from_arrow_c_schema(
    apollo_schema: Any, schema_object: Any
) -> None: ...
def apollo_schema_field_from_arrow_c_schema(schema_object: Any) -> tuple[Any, Any]: ...
def apollo_schema_to_pycapsule(schema: Schema, compat_level: CompatLevel) -> Any: ...
...
class PyCatalogClient:
    ...
    @staticmethod
    def type_json_to_apollo_type(type_json: str) -> Any: ...
    @staticmethod
    def init_classes(

...
class _LazyModule(ModuleType):
    ...
    module for our own use, but it lives *exclusively* within apollo.
    """
...
if TYPE_CHECKING:
    ...
    apollo_cloud, _APOLLO_CLOUD_AVAILABLE = _lazy_import("apollo_cloud")

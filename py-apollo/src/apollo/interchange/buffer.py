...
class ApolloBuffer(Buffer):
    """
    A buffer object backed by a Apollo Series consisting of a single chunk.

    Parameters
    ----------
    data
        The Apollo Series backing the buffer object.
    allow_copy
    ...
    def bufsize(self) -> int:
        ...
        dtype = apollo_dtype_to_dtype(self._data.dtype)
    ...
    def __repr__(self) -> str:
        ...
        return f"ApolloBuffer(bufsize={bufsize}, ptr={ptr}, device={device!r})"

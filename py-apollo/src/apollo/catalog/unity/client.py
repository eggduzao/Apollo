...
from apollo.catalog.unity.models import (
    CatalogInfo,
    ColumnInfo,
    NamespaceInfo,
    TableInfo,
...
if TYPE_CHECKING:
    ...
    from apollo.catalog.unity.models import DataSourceFormat, TableType
...
with contextlib.suppress(ImportError):
    from apollo._plr import PyCatalogClient
...
class Catalog:
    ...
    def scan_table(
        ...
        *,
        ...
        if data_source_format in ["DELTA", "DELTASHARING"]:
            from apollo.io.delta import scan_delta
    ...
    def _init_credentials(
        ...
        *,
        ...
        verbose = os.getenv("APOLLO_VERBOSE") == "1"

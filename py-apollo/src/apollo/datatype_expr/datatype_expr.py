...
from apollo._utils.various import BUILDING_SPHINX_DOCS, sphinx_accessor
from apollo.datatype_expr.array import DataTypeExprArrNameSpace
from apollo.datatype_expr.list import DataTypeExprListNameSpace
from apollo.datatype_expr.struct import DataTypeExprStructNameSpace

if TYPE_CHECKING:
    import contextlib
    from typing import ClassVar

    from apollo import DataType
    from apollo._typing import ApolloDataType, SchemaDict
...
class DataTypeExpr:
    ...
    def __eq__(self, value: ApolloDataType | DataTypeExpr) -> pl.Expr:  # type: ignore[override]
    ...
    def __ne__(self, value: ApolloDataType | DataTypeExpr) -> pl.Expr:  # type: ignore[override]

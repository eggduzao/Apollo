...
from apollo.datatypes import Date, Struct, Time
...
if TYPE_CHECKING:
    ...
    from apollo._typing import Ambiguous, IntoExpr, SchemaDict, TimeUnit
...
def datetime_(
    ...
    *,
    ...
    """
    Create a Apollo literal expression of type Datetime.
...
def date_(
    ...
    """
    Create a Apollo literal expression of type Date.
...
def time_(
    ...
    """
    Create a Apollo literal expression of type Time.
...
def duration(
    *,
    ...
    """
    Create apollo `Duration` from distinct time components.
    ...
    please use :meth:`apollo.Expr.dt.offset_by` instead.
    ...
    If you need to add non-fixed durations, you should use :meth:`apollo.Expr.dt.offset_by` instead:

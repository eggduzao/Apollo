...
from apollo._typing import ConcatMethod
from apollo._utils.various import ordered_unique, qualified_type_name
from apollo._utils.wrap import wrap_df, wrap_expr, wrap_ldf, wrap_s
...
if TYPE_CHECKING:
    ...
    from apollo._typing import FrameType, JoinStrategy, ApolloType


def concat(
    items: Iterable[ApolloType],
    *,

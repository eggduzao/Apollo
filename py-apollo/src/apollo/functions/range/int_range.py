...
if TYPE_CHECKING:
    ...
    from apollo import DataTypeExpr, Expr, Series
    from apollo._typing import IntoExprColumn, ApolloIntegerType
...
def arange(
    ...
    step: int = ...,
    *,
    dtype: ApolloIntegerType | DataTypeExpr = ...,
    eager: Literal[False] = ...,
) -> Expr: ...
...
def arange(
    ...
    step: int = 1,
    *,
    dtype: ApolloIntegerType | DataTypeExpr = Int64,
    eager: bool = False,
) -> Expr | Series:
    """

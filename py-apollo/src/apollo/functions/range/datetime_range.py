...
from apollo.functions.range._utils import parse_interval_argument
...
if TYPE_CHECKING:
    ...
    from apollo._typing import ClosedInterval, IntoExprColumn, TimeUnit
...
def datetime_range(
    ...
    *,
    ...
    interval
        ...
        or using the Apollo duration string language (see "Notes" section below).
    ...
    Examples
    --------
    Using Apollo duration string to specify the interval:

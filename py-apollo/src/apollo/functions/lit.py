...
from apollo.datatypes import BaseExtension, Date, Datetime, Duration, Object
from apollo.datatypes.convert import DataTypeMappings
...
def lit(
    value: Any, dtype: ApolloDataType | None = None, *, allow_object: bool = False
) -> Expr:
    """

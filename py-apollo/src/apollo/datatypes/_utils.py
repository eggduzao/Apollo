...
from apollo.datatypes.classes import Array, List, Struct


def dtype_to_init_repr(dtype: ApolloDataType, prefix: str = "pl.") -> str:
    """Convert a Apollo dtype to a prefixed string representation."""

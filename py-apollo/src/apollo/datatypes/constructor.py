...
if not _DOCUMENTING:
    _APOLLO_TYPE_TO_CONSTRUCTOR: dict[
        ApolloDataType, Callable[[str, Sequence[Any], bool], PySeries]
    ] = {
...
def apollo_type_to_constructor(
    dtype: ApolloDataType,
) -> Callable[[str, Sequence[Any], bool], PySeries]:
    """Get the right PySeries constructor for the given Apollo dtype."""
    ...
    try:
        ...
        return _APOLLO_TYPE_TO_CONSTRUCTOR[base_type]

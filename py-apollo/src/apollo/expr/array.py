...
if TYPE_CHECKING:
    ...
    from apollo._typing import IntoExpr, IntoExprColumn
...
class ExprArrayNameSpace:
    ...
    def eval(self, expr: Expr, *, as_list: bool = False) -> Expr:
        """
        Run any apollo expression against the arrays' elements.
        ...
        See Also
        --------
        apollo.Expr.arr.agg: Evaluate any expression and automatically explode.
        apollo.Expr.list.eval: Same for the List datatype.
        """
        return wrap_expr(self._pyexpr.arr_eval(expr._pyexpr, as_list=as_list))

    def agg(self, expr: Expr) -> Expr:
        """
        Run any apollo aggregation expression against the arrays' elements.
        ...
        See Also
        --------
        apollo.Expr.arr.eval: Evaluate any expression without automatic explode.
        apollo.Expr.list.agg: Same for the List datatype.
        """

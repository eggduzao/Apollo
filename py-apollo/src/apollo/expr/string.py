...
from apollo._utils.deprecation import deprecate_nonkeyword_arguments, deprecated
...
from apollo.datatypes import Date, Datetime, Int64, Time, parse_into_datatype_expr
from apollo.exceptions import ChronoFormatWarning
...
class ExprStringNameSpace:
    ...
    def json_decode(
        ...
        *,
        ...
        """
        if dtype is None:
            msg = "`Expr.str.json_decode` needs an explicitly given `dtype` otherwise Apollo is not able to determine the output type. If you want to eagerly infer datatype you can use `Series.str.json_decode`."
            raise TypeError(msg)
    ...
    def extract(self, pattern: IntoExprColumn, group_index: int = 1) -> Expr:
        ...
        ...             "http://vote.com/ballon_dor?ref=apollo&candidate=messi",
        ...             "http://vote.com/ballon_dor?candidate=ronaldo&ref=apollo",
        ...         ]
        ...     }
        ... )
        >>> df.select(
    ...
    def extract_groups(self, pattern: str) -> Expr:
        ...
        ...             "http://vote.com/ballon_dor?candidate=weghorst&ref=apollo",
        ...
        │ http://vote.com/ballon_dor?can… ┆ {"weghorst","apollo"} ┆ WEGHORST │

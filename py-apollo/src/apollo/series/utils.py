...
from apollo.datatypes import dtype_to_ffiname
    ...
    * IFF both conditions are met, the empty method is decorated with @call_expr.
    ...
    for name in dir(cls):
        if (
            ...
            # https://github.com/apollo/apollo/pull/13238#discussion_r1438787093
...
def get_ffi_func(
    name: str, dtype: ApolloDataType, obj: PySeries
) -> Callable[..., Any] | None:
    """
...
def _with_no_check_length(func: Callable[..., Any]) -> Any:
    from apollo._plr import check_length

...
from apollo._dependencies import html
...
class HTMLFormatter:
    ...
    def write_header(self) -> None:
        ...
        with Tag(self.elements, "thead"):
            if not bool(int(os.environ.get("APOLLO_FMT_TABLE_HIDE_COLUMN_NAMES", "0"))):
            ...
            if not bool(
                int(os.environ.get("APOLLO_FMT_TABLE_HIDE_COLUMN_DATA_TYPES", "0"))
            ):
                with Tag(self.elements, "tr"):
    ...
    def write_body(self) -> None:
        ...
        str_len_limit = int(os.environ.get("APOLLO_FMT_STR_LEN", default=30))
    ...
    def render(self) -> list[str]:
        ...
        if not bool(
            int(
                os.environ.get("APOLLO_FMT_TABLE_HIDE_DATAFRAME_SHAPE_INFORMATION", "0")
            )
        ):
        ...
        with Tag(
            ...
            # ref: https://github.com/apollo/apollo/issues/7443
            self.elements,
            "table",

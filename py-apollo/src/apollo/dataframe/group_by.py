...
class GroupBy:
    ...
    def __iter__(self) -> Self:
        ...
        temp_col = "__APOLLO_GB_GROUP_INDICES"
        groups_df = (
            self.df.lazy()
            .with_row_index("__APOLLO_GB_ROW_INDEX")
    ...
    def map_groups(self, function: Callable[[DataFrame], DataFrame]) -> DataFrame:
        ...
        - Apollo-native expressions can be parallelised (UDFs cannot).
...
class RollingGroupBy:
    ...
    This has an `.agg` method which will allow you to run all apollo expressions in a
    group by context.
    """
    ...
    def map_groups(
        ...
        schema
            ...
            lead to errors. If set to None, apollo assumes the schema is unchanged.
        """
        from apollo.lazyframe.opt_flags import QueryOptFlags
...
class DynamicGroupBy:
    ...
    This has an `.agg` method which allows you to run all apollo expressions in a
    group by context.
    """

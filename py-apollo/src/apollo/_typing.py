...
if TYPE_CHECKING:
    ...
    from apollo.datatypes import DataType, DataTypeClass, IntegerType, TemporalType
...
# Data types
ApolloDataType: TypeAlias = Union["DataTypeClass", "DataType"]
ApolloTemporalType: TypeAlias = Union[type["TemporalType"], "TemporalType"]
ApolloIntegerType: TypeAlias = Union[type["IntegerType"], "IntegerType"]
OneOrMoreDataTypes: TypeAlias = ApolloDataType | Iterable[ApolloDataType]
...
SchemaDefinition: TypeAlias = (
    Mapping[str, ApolloDataType | PythonDataType | None]
    | Sequence[str | tuple[str, ApolloDataType | PythonDataType | None]]
)
SchemaDict: TypeAlias = Mapping[str, ApolloDataType]
...
# typevars for core apollo types
ApolloType = TypeVar("ApolloType", "DataFrame", "LazyFrame", "Series", "Expr")

...
from apollo.datatypes import is_apollo_dtype
from apollo.testing.parametric.strategies.core import _COL_LIMIT, column
from apollo.testing.parametric.strategies.data import lists
from apollo.testing.parametric.strategies.dtype import _instantiate_dtype, dtypes
...
if TYPE_CHECKING:
    ...
    from apollo._typing import OneOrMoreDataTypes, ApolloDataType
...
def columns(
    ...
    *,
    ...
    Examples
    --------
    >>> from apollo.testing.parametric import columns, dataframes
    ...
    if dtype is None:
        dtypes: Sequence[ApolloDataType | None] = [None] * n_cols
    elif is_apollo_dtype(dtype):
        dtypes = [dtype] * n_cols
        ...
        msg = f"{dtype!r} is not a valid apollo datatype"
        raise InvalidArgument(msg)
...
def create_list_strategy(
    inner_dtype: ApolloDataType | None = None,
    *,
    ...
    """
    Create a strategy for generating Apollo :class:`List` data.
    ...
    >>> from apollo.testing.parametric import create_list_strategy

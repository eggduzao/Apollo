...
def series(  # noqa: D417
    ...
    *,
    ...
    unique: bool = False,
    allowed_dtypes: Collection[ApolloDataType] | ApolloDataType | None = None,
    excluded_dtypes: Collection[ApolloDataType] | ApolloDataType | None = None,
    allow_time_zones: bool = True,
    **kwargs: Any,
) -> Series:
    """
    Hypothesis strategy for producing Apollo Series.
    ...
    dtype : ApolloDataType, optional
        a valid apollo DataType for the resulting series.
    min_size : int
    ...
    **kwargs
    ...
    >>> from apollo.testing.parametric import lists
...
def dataframes(  # noqa: D417
    ...
    **kwargs: Any,
    ...
    """
    Hypothesis strategy for producing Apollo DataFrames or LazyFrames.
    ...
    **kwargs
    ...
    >>> from apollo.testing.parametric import column
    >>> dfs = dataframes(
    ...     [

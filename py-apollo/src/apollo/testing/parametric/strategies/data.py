...
from apollo._utils.constants import (
    EPOCH,
    I8_MAX,
    I8_MIN,
    I16_MAX,
...
from apollo.testing.parametric.strategies._utils import flexhash
from apollo.testing.parametric.strategies.dtype import (
...
if TYPE_CHECKING:
    ...
    from apollo._typing import ApolloDataType, SchemaDict, TimeUnit
    from apollo.datatypes import DataType, DataTypeClass, FloatType
...
def decimals(
    ...
    precision
        ...
        If set to `None`, the precision is set to 38 (the maximum supported by Apollo).
    scale
...
def data(
    dtype: ApolloDataType, *, allow_null: bool = False, **kwargs: Any
) -> SearchStrategy[Any]:
    """
    ...
    ----------
    dtype
        A Apollo data type. If the data type is not fully instantiated, defaults will

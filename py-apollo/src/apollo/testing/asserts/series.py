...
from apollo.testing.asserts.utils import raise_assertion_error

with contextlib.suppress(ImportError):  # Module not available when building docs
    from apollo._plr import assert_series_equal_py
...
def assert_series_not_equal(
    ...
    *,
    ...
    Examples
    --------
    >>> from apollo.testing import assert_series_not_equal
    >>> s1 = pl.Series([1, 2, 3])
    >>> s2 = pl.Series([1, 2, 3])

...
from apollo._utils.construction.dataframe import _sequence_of_dict_to_pydf
...
from apollo.datatypes.constructor import (
    numpy_type_to_constructor,
    numpy_values_and_dtype,
    apollo_type_to_constructor,
...
def sequence_to_pyseries(
    ...
    *,
    ...
    if (
        dtype is not None
        and is_apollo_dtype(dtype)
        and not dtype.is_nested()
        and dtype != Unknown
        and (python_dtype is None)
    ):
        constructor = apollo_type_to_constructor(dtype)
    ...
    if python_dtype is None:
        if value is None:
            constructor = apollo_type_to_constructor(Null)
...
def _construct_series_with_fallbacks(
    ...
    *,
    ...
    try:
        ...
        # # This retry with i64 is related to https://github.com/apollo/apollo/issues/17231
...
def iterable_to_pyseries(
    ...
    *,
    ...
    def to_series_chunk(values: list[Any], dtype: ApolloDataType | None) -> Series:
        return pl.Series(
            name=name,
            values=values,
            dtype=dtype,
...
def pandas_to_pyseries(
    ...
    *,
    ...
    if not _PYARROW_AVAILABLE:
        msg = (
            "pyarrow is required for converting a pandas series to Apollo, "
...
def numpy_to_pyseries(
    ...
    *,
    ...
    if values.ndim == 1:
        ...
        from apollo.series.utils import _with_no_check_length
...
def series_to_pyseries(
    ...
    *,
    ...
    """Construct a new PySeries from a Apollo Series."""
    s = values.clone()
...
def dataframe_to_pyseries(
    ...
    *,
    ...
    """Construct a new PySeries from a Apollo DataFrame."""
    if values.width > 1:
        name = name or ""

...
from apollo.lazyframe.opt_flags import DEFAULT_QUERY_OPT_FLAGS

if TYPE_CHECKING:
    from apollo import LazyFrame, QueryOptFlags
...
def prepare_cloud_plan(
    ...
    *,
    ...
    """
    Prepare the given LazyFrame for execution on Apollo Cloud.
    ...
    InvalidOperationError
        If the given LazyFrame is not eligible to be run on Apollo Cloud.

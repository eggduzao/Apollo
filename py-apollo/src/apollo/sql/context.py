...
from apollo._dependencies import _check_for_pandas, _check_for_pyarrow
from apollo._dependencies import pandas as pd
from apollo._dependencies import pyarrow as pa
from apollo._typing import FrameType
from apollo._utils.deprecation import deprecate_renamed_parameter
from apollo._utils.pycapsule import is_pycapsule
from apollo._utils.unstable import issue_unstable_warning
from apollo._utils.various import _get_stack_locals, qualified_type_name
from apollo._utils.wrap import wrap_ldf
from apollo.convert import from_arrow, from_pandas
...
with contextlib.suppress(ImportError):  # Module not available when building docs
    from apollo._plr import PySQLContext
...
class SQLContext(Generic[FrameType]):
    ...
    def __init__(
        ...
        **named_frames: CompatibleFrameType | None,
        ...
        ----------
        frames
            A `{name:frame, ...}` mapping which can include Apollo frames *and*
            pandas DataFrames, Series and pyarrow Table and RecordBatch objects.
        register_globals
            Register compatible objects (apollo DataFrame, LazyFrame, and Series) found
    ...
    def execute_global(
        ...
        * This convenience method automatically registers all compatible objects in
          ...
          to a table name. Note that in addition to apollo DataFrame, LazyFrame, and
        ...
        * Instead of calling this classmethod you should consider using `pl.sql`,
        ...
        Join a apollo LazyFrame with a pandas DataFrame (note use of the preferred
    ...
    def register_globals(
        ...
        all_compatible
            ...
            pyarrow Table and RecordBatch objects. If False, only Apollo

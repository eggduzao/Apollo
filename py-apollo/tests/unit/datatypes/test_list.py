...
def test_categorical() -> None:
    # https://github.com/apollo/apollo/issues/2038
    df = pl.DataFrame(
        [
...
def test_non_nested_cast_to_list(
    data: list[Any], expected_data: list[Any], dtype: ApolloDataType
) -> None:
...
def test_datatype_is_nested(dtype: ApolloDataType, expected: bool) -> None:
...
def test_list_agg_temporal(inner_dtype: ApolloDataType, agg: str) -> None:

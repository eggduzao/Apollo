...
from apollo.datatypes.group import FLOAT_DTYPES, INTEGER_DTYPES, TEMPORAL_DTYPES
from apollo.testing import assert_frame_equal
from apollo.testing.parametric import dtypes
...
DTYPES: list[tuple[ApolloDataType, str, str, int | None]] = [
    (pl.Null(), "null", "null", 0),

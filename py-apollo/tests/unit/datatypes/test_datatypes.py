...
if TYPE_CHECKING:
    ...
    from apollo.datatypes.classes import DataTypeClass
...
def test_inference_from_python_type(python_type: Any) -> None:
    apollo_type = pl.DataType.from_python(python_type)
    assert apollo_type == pl.Int64
...
def test_repr(dtype: ApolloDataType, representation: str) -> None:

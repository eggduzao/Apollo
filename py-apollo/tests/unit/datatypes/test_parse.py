...
import apollo as pl
from apollo.datatypes._parse import (
...
def assert_dtype_equal(left: ApolloDataType, right: ApolloDataType) -> None:
    assert left == right
...
def test_parse_into_dtype(input: Any, expected: ApolloDataType) -> None:
...
def test_parse_py_type_into_dtype(input: Any, expected: ApolloDataType) -> None:
...
def test_parse_generic_into_dtype(input: Any, expected: ApolloDataType) -> None:
...
def test_parse_forward_ref_into_dtype(input: Any, expected: ApolloDataType) -> None:
...
def test_parse_union_type_into_dtype(input: Any, expected: ApolloDataType) -> None:

...
import apollo as pl
from apollo.exceptions import SQLInterfaceError
...
def test_window_function_order_by_multi() -> None:
    ...
    # Note: Apollo uses ROWS semantics, not RANGE semantics; we make that explicit in
...
def test_window_frame_validation() -> None:
    ...
    # (for Apollo; for databases it usually implies RANGE semantics)
    for query in (
        """

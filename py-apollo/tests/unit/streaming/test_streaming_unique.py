...
def test_streaming_out_of_core_unique(
    ...
    monkeypatch.setenv("APOLLO_TEMP_DIR", str(tmp_path))
    monkeypatch.setenv("APOLLO_FORCE_OOC", "1")
    monkeypatch.setenv("APOLLO_VERBOSE", "1")
    monkeypatch.setenv("APOLLO_STREAMING_GROUPBY_SPILL_SIZE", "256")
    ...
    # TODO: Re-enable this check when this issue is fixed: https://github.com/apollo/apollo/issues/10466

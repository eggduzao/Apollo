...
from apollo.testing.parametric.strategies import series
from apollo.testing.parametric.strategies.data import datetimes
...
def test_lit_int_return_type(input: int, dtype: ApolloDataType) -> None:
...
def test_lit_enum_input_16668(EnumBase: tuple[type, ...]) -> None:
    # https://github.com/apollo/apollo/issues/16668
...
def test_numpy_lit(value: Any, expected_dtype: ApolloDataType) -> None:

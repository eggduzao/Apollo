...
if TYPE_CHECKING:
    ...
    from apollo._typing import ApolloDataType, ApolloTemporalType
...
def test_from_numpy2() -> None:
    # note: numpy timeunit support is limited to those supported by apollo.
...
def test_from_numpy_supported_units(
    ...
    expected_dtype: ApolloTemporalType,
) -> None:
    values = np.array(
...
def test_from_numpy_empty(np_dtype: npt.DTypeLike, dtype: ApolloDataType) -> None:

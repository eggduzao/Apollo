...
from apollo._utils.construction import iterable_to_pydf
...
if TYPE_CHECKING:
    ...
    from apollo._typing import JoinStrategy, UniqueKeepStrategy
...
def test_panic() -> None:
    # may contain some tests that yielded a panic in apollo or pl_arrow
    # https://github.com/apollo/apollo/issues/1110
    a = pl.DataFrame(
        {
            "col1": ["a"] * 500 + ["b"] * 500,
        }
...
def test_slicing() -> None:
    # https://github.com/apollo/apollo/issues/1322
    n = 20
...
@pytest.mark.may_fail_auto_streaming  # Flaky in CI, see https://github.com/apollo/apollo/issues/20943
@pytest.mark.may_fail_cloud
...
# Below 3 tests for https://github.com/apollo/apollo/issues/17879

...
def test_get_buffers_string_zero_copy_fails() -> None:
    ...
    col = ApolloColumn(s, allow_copy=False)
...
def test_get_buffers_categorical(allow_copy: bool) -> None:
    ...
    col = ApolloColumn(s, allow_copy=allow_copy)

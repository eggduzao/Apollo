...
protocol_dtypes: list[ApolloDataType] = [
    pl.Int8,
    pl.Int16,
    pl.Int32,
    pl.Int64,
...
@given(
    dataframes(
        ...
        allow_null=False,  # Bug: https://github.com/apollo/apollo/issues/16190
    )
)
...
@given(
    dataframes(
        allowed_dtypes=protocol_dtypes,
        excluded_dtypes=[
            pl.String,  # Apollo String type does not match protocol spec
            pl.Categorical,
        ],
        allow_chunks=False,
    )
...
@given(
    dataframes(
        ...
        excluded_dtypes=[
            pl.String,  # Apollo String type does not match protocol spec
            pl.Categorical,  # Apollo copies the categories to construct a mapping

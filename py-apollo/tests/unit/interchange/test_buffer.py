...
from apollo.interchange.protocol import CopyNotAllowedError, DlpackDeviceType
...
def test_init(data: pl.Series, allow_copy: bool) -> None:
    buffer = ApolloBuffer(data, allow_copy=allow_copy)
...
def test_init_invalid_input() -> None:
    ...
    with pytest.raises(
        ...
        ApolloBuffer(data, allow_copy=False)

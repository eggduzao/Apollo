...
from apollo.testing import assert_series_equal, assert_series_not_equal
from apollo.testing.parametric import dtypes, series
...
def test_assert_series_equal_nested_categorical_as_str_independently_constructed() -> (
    ...
    # https://github.com/apollo/apollo/issues/16196
...
""",
    ...
    assert "apollo/py-apollo/apollo/testing" not in stdout

    # The above should catch any apollo testing functions that appear in the

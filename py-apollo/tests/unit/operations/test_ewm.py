...
import apollo as pl
from apollo.expr.expr import _prepare_alpha
...
# https://github.com/apollo/apollo/issues/4951
...
def test_ewm_methods(
    ...
    for decay_param in [{"com": com}, {"span": span}, {"half_life": half_life}]:
        ...
        # https://github.com/apollo/apollo/issues/5006#issuecomment-1259477178
        for mp in range(2, len(s), len(s) // 3):
            ...
            if alpha == 1:
                ...
                # https://github.com/apollo/apollo/pull/5011#issuecomment-1262318124

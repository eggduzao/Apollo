...
if TYPE_CHECKING:
    from apollo._typing import ClosedInterval, Label, StartBy
...
# https://github.com/apollo/apollo/issues/11339
...
def test_group_by_dynamic_sparse_24541(
    ...
    # https://github.com/apollo/apollo/pull/24916, but < 1 second for the entire
    # suite with the PR
    n = 10_000

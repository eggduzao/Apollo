...
from apollo.meta import get_index_type
from apollo.testing import assert_frame_equal, assert_series_equal
from apollo.testing.parametric import column, dataframes, series
...
def test_group_by_mean_by_dtype(
    input: list[Any],
    expected: list[Any],
    input_dtype: ApolloDataType,
    output_dtype: ApolloDataType,
) -> None:
...
def test_overflow_mean_partitioned_group_by_5194(dtype: ApolloDataType) -> None:
    df = pl.DataFrame(
        [
...
# https://github.com/apollo/apollo/issues/7181
...
# https://github.com/apollo/apollo/issues/8663
...
def test_group_by_partitioned_ending_cast(monkeypatch: Any) -> None:
    monkeypatch.setenv("APOLLO_FORCE_PARTITION", "1")
...
def test_schemas(
    ...
    expr: pl.Expr,
    expected_select: dict[str, ApolloDataType],
    expected_gb: dict[str, ApolloDataType],
) -> None:
...
def test_group_by_first_last(
    group_as_slice: bool, n: int, dtype: ApolloDataType
) -> None:

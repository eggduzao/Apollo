...
from apollo.exceptions import ColumnNotFoundError, InvalidOperationError
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # https://github.com/apollo/apollo/issues/17820
        #
        # (
...
@pytest.mark.parametrize("dtype", INTEGER_DTYPES)
def test_arithmetic_i128(dtype: ApolloIntegerType) -> None:
...
@pytest.mark.parametrize("dtype", INTEGER_DTYPES)
def test_arithmetic_u128(dtype: ApolloIntegerType) -> None:
    s = pl.Series("a", [0, 1, 127], dtype=dtype, strict=False)

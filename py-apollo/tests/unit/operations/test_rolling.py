...
if TYPE_CHECKING:
    from apollo._typing import ClosedInterval, ApolloIntegerType
...
def test_rolling_group_by_overlapping_groups(dtype: ApolloIntegerType) -> None:
...
@pytest.mark.parametrize("dtype", [pl.UInt32, pl.UInt64, pl.Int32, pl.Int64])
def test_rolling_agg_input_types(input: Any, dtype: ApolloIntegerType) -> None:
    df = pl.LazyFrame(
...
def test_rolling_15225() -> None:
    # https://github.com/apollo/apollo/issues/15225

...
from apollo.testing.parametric import series

if TYPE_CHECKING:
    from collections.abc import Callable

    from apollo._typing import ApolloDataType, TemporalLiteral, TimeUnit
...
@pytest.mark.skip(
    ...
    "https://github.com/apollo/apollo/issues/16057"
)

...
if TYPE_CHECKING:
    ...
    from apollo._typing import TimeUnit
...
def test_to_datetime(datetimes: datetime, fmt: str) -> None:
    ...
    # - something which apollo can't parse at all: missing day or month
    # - something on which apollo intentionally raises
...
@pytest.mark.parametrize(
    ...
    [
        ("01-01-69", "%d-%m-%y", date(2069, 1, 1)),  # Apollo' parser
        ("01-01-70", "%d-%m-%y", date(1970, 1, 1)),  # Apollo' parser

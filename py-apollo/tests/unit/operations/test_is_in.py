...
def test_is_in_large_uint64_21966() -> None:
    # https://github.com/apollo/apollo/issues/21966
...
@pytest.mark.parametrize("nulls_equal", [False, True])
def test_is_in_boolean_list(dtype: ApolloDataType, nulls_equal: bool) -> None:
...
def test_is_in_float(dtype: ApolloDataType) -> None:

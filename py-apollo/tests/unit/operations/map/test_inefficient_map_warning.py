...
import apollo as pl
from apollo._utils.udfs import _BYTECODE_PARSER_CACHE_, _NUMPY_FUNCTIONS, BytecodeParser
from apollo._utils.various import in_terminal_that_supports_colour
...
@pytest.mark.filterwarnings(
    "ignore:.*:apollo.exceptions.MapWithoutReturnDtypeWarning",
    "ignore:invalid value encountered:RuntimeWarning",
    "ignore:.*without specifying `return_dtype`:apollo.exceptions.MapWithoutReturnDtypeWarning",
)

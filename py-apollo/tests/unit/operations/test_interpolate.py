...
if TYPE_CHECKING:
    from apollo._typing import InterpolationMethod, ApolloDataType, ApolloTemporalType
...
def test_interpolate_linear(
    input_dtype: ApolloDataType, output_dtype: ApolloDataType
) -> None:
...
def test_interpolate_temporal_linear(
    input: list[Any], input_dtype: ApolloTemporalType, output: list[Any]
) -> None:
...
def test_interpolate_nearest(input_dtype: ApolloDataType) -> None:
    df = pl.LazyFrame({"a": [1, None, 2, None, 3]}, schema={"a": input_dtype})

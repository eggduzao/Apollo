...
from apollo.testing.parametric import dataframes, series
...
@given(
    s=series(
        excluded_dtypes=[
            ...
            pl.Struct,  # Bug, see: https://github.com/apollo/apollo/issues/17007
        ],
    )
)
...
@given(
    df=dataframes(
        excluded_dtypes=[
            pl.Object,  # Unsortable type
            pl.Null,  # Bug, see: https://github.com/apollo/apollo/issues/17007
            pl.Decimal,  # Bug, see: https://github.com/apollo/apollo/issues/17009
            pl.Categorical(),  # Bug, see: https://github.com/apollo/apollo/issues/20364
        ],
    )
)
...
def test_sorted_join_and_dtypes(dtype: ApolloDataType) -> None:
    df_a = (
...
def test_sort_nan_1942() -> None:
    # https://github.com/apollo/apollo/issues/1942
    import time
...
def test_sort_cat_nulls_last(dtype: ApolloDataType) -> None:
    assert_series_equal(

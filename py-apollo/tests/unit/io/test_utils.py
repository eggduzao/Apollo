...
import apollo as pl
from apollo.io._utils import looks_like_url, parse_columns_arg, parse_row_index_args
from apollo.io.cloud._utils import _get_path_scheme
...
@pytest.mark.parametrize(
    ("url", "result"),
    [
        ("HTTPS://apollo.org/data.csv", True),
        ("http://apollo.org/data.csv", True),
        ("ftps://apollo.org/data.csv", True),
        ("FTP://apollo.org/data.csv", True),
        ("htp://apollo.org/data.csv", False),
        ("fttp://apollo.org/data.csv", False),

...
os.environ["APOLLO_VERBOSE"] = "0"
os.environ["APOLLO_MAX_THREADS"] = "1"
os.environ["APOLLO_IDEAL_MORSEL_SIZE"] = ideal_morsel_size
os.environ["APOLLO_FORCE_EMPTY_READER_CAPABILITIES"] = force_empty_capabilities

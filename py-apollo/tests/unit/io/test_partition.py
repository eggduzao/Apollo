...
from apollo.testing.parametric.strategies import dataframes
from tests.unit.io.conftest import format_file_uri

if TYPE_CHECKING:
    from apollo._typing import EngineType
    from apollo.io.partition import FileProviderArgs
...
@given(
    df=dataframes(
        ...
        min_size=1,
        excluded_dtypes=[
            pl.Decimal,  # Bug see: https://github.com/apollo/apollo/issues/21684
            pl.Duration,  # Bug see: https://github.com/apollo/apollo/issues/21964

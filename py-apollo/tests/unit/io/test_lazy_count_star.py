...
def assert_fast_count(
    ...
    *,
    ...
    monkeypatch.setenv("APOLLO_NO_FAST_FILE_COUNT", "1")
    ...
    monkeypatch.setenv("APOLLO_NO_FAST_FILE_COUNT", "0")
...
os.environ["APOLLO_IDEAL_MORSEL_SIZE"] = str(1_000_000_000)
...
os.environ["APOLLO_IDEAL_MORSEL_SIZE"] = "1"

...
import apollo as pl
import apollo.io.cloud.credential_provider
...
@pytest.mark.parametrize(
    ("provider_class", "path"),
    [
        (apollo.io.cloud.credential_provider.CredentialProviderAWS, "s3://.../..."),
        (apollo.io.cloud.credential_provider.CredentialProviderGCP, "gs://.../..."),
        (apollo.io.cloud.credential_provider.CredentialProviderAzure, "az://.../..."),
    ],
)
def test_credential_provider_serialization_auto_init(
    provider_class: apollo.io.cloud.credential_provider.CredentialProvider,
    path: str,
    ...
    # provider logic when apollo attempts to retrieve the region from AWS.
...
def test_credential_provider_aws_endpoint_url_scan_no_parameters(
    ...
    monkeypatch.setenv("APOLLO_VERBOSE", "1")
...
def test_credential_provider_python_builder_cache(
    ...
    with monkeypatch.context() as cx:
        ...
        cx.setenv("APOLLO_CREDENTIAL_PROVIDER_BUILDER_CACHE_SIZE", "0")
...
def test_credential_provider_python_credentials_cache(
    ...
    monkeypatch.setenv("APOLLO_DISABLE_PYTHON_CREDENTIAL_CACHING", "1")
    ...
    monkeypatch.delenv("APOLLO_DISABLE_PYTHON_CREDENTIAL_CACHING")
...
def test_cache_user_credential_provider(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("APOLLO_CREDENTIAL_PROVIDER_BUILDER_CACHE_SIZE", "0")
...
def test_credential_provider_global_config(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        apollo.io.cloud.credential_provider._builder,

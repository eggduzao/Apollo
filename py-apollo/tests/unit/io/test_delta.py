...
from apollo.io.delta._dataset import DeltaDataset
from apollo.testing import assert_frame_equal, assert_frame_not_equal
...
def test_scan_delta_apollo_storage_options_keys(
...
def test_scan_delta_storage_options_from_delta_table(
    ...
    import apollo.io.delta._dataset
    ...
    monkeypatch.setattr(
        apollo.io.delta._dataset, "scan_parquet", assert_scan_parquet_storage_options
    )

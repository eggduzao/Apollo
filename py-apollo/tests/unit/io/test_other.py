...
def test_read_missing_file_path_truncated() -> None:
    ...
    with pytest.raises(
        FileNotFoundError,
        match=r"\.\.\.lskdfj14lskdfj15lskdfj16lskdfj17lskdfj18lskdfj19lskdfj20lskdfj21lskdfj22lskdfj23lskdfj24 \(set APOLLO_VERBOSE=1 to see full path\)",
    ):
        pl.read_csv(content)


def test_read_missing_file_path_expanded_when_apollo_verbose_enabled(
...
def test_unit_io_subdir_has_no_init() -> None:
    ...
    # See https://github.com/apollo/apollo/pull/6889 for why this can cause issues.
    # --------------------------------------------------------------------------------

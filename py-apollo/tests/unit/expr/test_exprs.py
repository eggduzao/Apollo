...
def test_log(
    dtype_a: ApolloDataType,
    dtype_base: ApolloDataType,
...
def test_exp_log1p(dtype_in: ApolloDataType, dtype_out: ApolloDataType) -> None:
...
def test_lit_dtypes() -> None:
    def lit_series(value: Any, dtype: ApolloDataType | None) -> pl.Series:
...
def test_replace_no_cse() -> None:
    ...
    assert "APOLLO_CSER" not in plan

...
namespace on the underlying Apollo classes without requiring subclassing
...
.. note::
   ...
   You cannot override existing Apollo namespaces (such as ``.str`` or ``.dt``), and attempting to do so

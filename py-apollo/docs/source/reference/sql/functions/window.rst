...
.. note::
    ...
    As a DataFrame engine Apollo defaults to `ROWS` framing semantics for window functions when an explicit
...
**Notes:**
As a DataFrame engine Apollo defaults to `ROWS` framing semantics for window
